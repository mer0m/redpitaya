...
class MyApp(App):
	...
	def main(self):
		...
		self.lb_pid3_kp = gui.Label("/dev/pid3_kp", width="20%", margin="10px")
		...
		self.hbox_pid3_ki = gui.HBox(margin="10px")
		self.lb_pid3_ki = gui.Label("/dev/pid3_ki", width="20%", margin="10px")
		self.sd_pid3_ki = gui.Slider(0, -8192, 8191, 1, width="60%", margin="10px")
		self.sd_pid3_ki.set_oninput_listener(self.sd_pid3_ki_changed)
		self.sb_pid3_ki = gui.SpinBox(0, -8192, 8191, 1, width="20%", margin="10px")
		self.sb_pid3_ki.set_on_change_listener(self.sb_pid3_ki_changed)
		self.sd_pid3_ki_changed(self.sd_pid3_ki, self.sd_pid3_ki.get_value())
		self.hbox_pid3_ki.append(self.lb_pid3_ki)
		self.hbox_pid3_ki.append(self.sd_pid3_ki)
		self.hbox_pid3_ki.append(self.sb_pid3_ki)
		self.w.append(self.hbox_pid3_ki)

		self.hbox_pid3_kd = gui.HBox(margin="10px")
		self.lb_pid3_kd = gui.Label("/dev/pid3_kd", width="20%", margin="10px")
		self.sd_pid3_kd = gui.Slider(0, -8192, 8191, 1, width="60%", margin="10px")
		self.sd_pid3_kd.set_oninput_listener(self.sd_pid3_kd_changed)
		self.sb_pid3_kd = gui.SpinBox(0, -8192, 8191, 1, width="20%", margin="10px")
		self.sb_pid3_kd.set_on_change_listener(self.sb_pid3_kd_changed)
		self.sd_pid3_kd_changed(self.sd_pid3_kd, self.sd_pid3_kd.get_value())
		self.hbox_pid3_kd.append(self.lb_pid3_kd)
		self.hbox_pid3_kd.append(self.sd_pid3_kd)
		self.hbox_pid3_kd.append(self.sb_pid3_kd)
		self.w.append(self.hbox_pid3_kd)

		self.hbox_pid3_setpoint = gui.HBox(margin="10px")
		self.lb_pid3_setpoint = gui.Label("/dev/pid3_setpoint", width="20%", margin="10px")
		self.sd_pid3_setpoint = gui.Slider(0, -8192, 8191, 1, width="60%", margin="10px")
		self.sd_pid3_setpoint.set_oninput_listener(self.sd_pid3_setpoint_changed)
		self.sb_pid3_setpoint = gui.SpinBox(0, -8192, 8191, 1, width="20%", margin="10px")
		self.sb_pid3_setpoint.set_on_change_listener(self.sb_pid3_setpoint_changed)
		self.sd_pid3_setpoint_changed(self.sd_pid3_setpoint, self.sd_pid3_setpoint.get_value())
		self.hbox_pid3_setpoint.append(self.lb_pid3_setpoint)
		self.hbox_pid3_setpoint.append(self.sd_pid3_setpoint)
		self.hbox_pid3_setpoint.append(self.sb_pid3_setpoint)
		self.w.append(self.hbox_pid3_setpoint)

		self.hbox_pid3_sign = gui.HBox(margin="10px")
		self.lb_pid3_sign = gui.Label("/dev/pid3_sign", width="20%", margin="10px")
		self.sd_pid3_sign = gui.Slider(0, -8192, 8191, 1, width="60%", margin="10px")
		self.sd_pid3_sign.set_oninput_listener(self.sd_pid3_sign_changed)
		self.sb_pid3_sign = gui.SpinBox(0, -8192, 8191, 1, width="20%", margin="10px")
		self.sb_pid3_sign.set_on_change_listener(self.sb_pid3_sign_changed)
		self.sd_pid3_sign_changed(self.sd_pid3_sign, self.sd_pid3_sign.get_value())
		self.hbox_pid3_sign.append(self.lb_pid3_sign)
		self.hbox_pid3_sign.append(self.sd_pid3_sign)
		self.hbox_pid3_sign.append(self.sb_pid3_sign)
		self.w.append(self.hbox_pid3_sign)

		self.hbox_pid3_rst_int = gui.HBox(margin="10px")
		self.lb_pid3_rst_int = gui.Label("/dev/pid3_rst_int", width="20%", margin="10px")
		self.sd_pid3_rst_int = gui.Slider(0, -8192, 8191, 1, width="60%", margin="10px")
		self.sd_pid3_rst_int.set_oninput_listener(self.sd_pid3_rst_int_changed)
		self.sb_pid3_rst_int = gui.SpinBox(0, -8192, 8191, 1, width="20%", margin="10px")
		self.sb_pid3_rst_int.set_on_change_listener(self.sb_pid3_rst_int_changed)
		self.sd_pid3_rst_int_changed(self.sd_pid3_rst_int, self.sd_pid3_rst_int.get_value())
		self.hbox_pid3_rst_int.append(self.lb_pid3_rst_int)
		self.hbox_pid3_rst_int.append(self.sd_pid3_rst_int)
		self.hbox_pid3_rst_int.append(self.sb_pid3_rst_int)
		self.w.append(self.hbox_pid3_rst_int)

		self.hbox_mod_amp_dds_ampl = gui.HBox(margin="10px")
		self.lb_mod_amp_dds_ampl = gui.Label("/dev/mod_amp_dds_ampl", width="20%", margin="10px")
		self.sd_mod_amp_dds_ampl = gui.Slider(0, -8192, 8191, 1, width="60%", margin="10px")
		self.sd_mod_amp_dds_ampl.set_oninput_listener(self.sd_mod_amp_dds_ampl_changed)
		self.sb_mod_amp_dds_ampl = gui.SpinBox(0, -8192, 8191, 1, width="20%", margin="10px")
		self.sb_mod_amp_dds_ampl.set_on_change_listener(self.sb_mod_amp_dds_ampl_changed)
		self.sd_mod_amp_dds_ampl_changed(self.sd_mod_amp_dds_ampl, self.sd_mod_amp_dds_ampl.get_value())
		self.hbox_mod_amp_dds_ampl.append(self.lb_mod_amp_dds_ampl)
		self.hbox_mod_amp_dds_ampl.append(self.sd_mod_amp_dds_ampl)
		self.hbox_mod_amp_dds_ampl.append(self.sb_mod_amp_dds_ampl)
		self.w.append(self.hbox_mod_amp_dds_ampl)
		...
		self.hbox_mod_amp_dds_nco = gui.HBox(margin="10px")
		self.lb_mod_amp_dds_nco = gui.Label("/dev/mod_amp_dds_nco", width="20%", margin="10px")
		self.sd_mod_amp_dds_nco = gui.Slider(0, 0, 62500000, 1, width="50%", margin="10px")
		self.sd_mod_amp_dds_nco.set_oninput_listener(self.sd_mod_amp_dds_nco_changed)
		self.sb_mod_amp_dds_nco = gui.SpinBox(0, 0, 62500000, 1, width="20%", margin="10px")
		self.sb_mod_amp_dds_nco.set_on_change_listener(self.sb_mod_amp_dds_nco_changed)
		self.cb_pinc_mod_amp_dds_nco = gui.CheckBoxLabel("pinc", True, width="5%", margin="10px")
		self.cb_pinc_mod_amp_dds_nco.set_on_change_listener(self.cb_mod_amp_dds_nco_changed)
		self.cb_poff_mod_amp_dds_nco = gui.CheckBoxLabel("poff", True, width="5%", margin="10px")
		self.cb_poff_mod_amp_dds_nco.set_on_change_listener(self.cb_mod_amp_dds_nco_changed)
		self.sd_mod_amp_dds_nco_changed(self.sd_mod_amp_dds_nco, self.sd_mod_amp_dds_nco.get_value())
		self.hbox_mod_amp_dds_nco.append(self.lb_mod_amp_dds_nco)
		self.hbox_mod_amp_dds_nco.append(self.sd_mod_amp_dds_nco)
		self.hbox_mod_amp_dds_nco.append(self.sb_mod_amp_dds_nco)
		self.hbox_mod_amp_dds_nco.append(self.cb_pinc_mod_amp_dds_nco)
		self.hbox_mod_amp_dds_nco.append(self.cb_poff_mod_amp_dds_nco)
		self.w.append(self.hbox_mod_amp_dds_nco)
	...
	def sd_dds1_f0_changed(self, widget, value):
		...
		liboscimp_fpga.add_const_set_offset("/dev/dds1_f0", int(round(int(value)/(125e6/2**32))))
	...
	def sd_pid3_kp_changed(self, widget, value):
		print("/dev/pid3_kp", int(value))
		liboscimp_fpga.add_const_set_offset("/dev/pid3_kp", int(value))
		self.sb_pid3_kp.set_value(value)

	def sb_pid3_kp_changed(self, widget, value):
		print("/dev/pid3_kp", int(value))
		liboscimp_fpga.add_const_set_offset("/dev/pid3_kp", int(value))
		self.sd_pid3_kp.set_value(value)

	def sd_pid3_ki_changed(self, widget, value):
		print("/dev/pid3_ki", int(value))
		liboscimp_fpga.add_const_set_offset("/dev/pid3_ki", int(value))
		self.sb_pid3_ki.set_value(value)

	def sb_pid3_ki_changed(self, widget, value):
		print("/dev/pid3_ki", int(value))
		liboscimp_fpga.add_const_set_offset("/dev/pid3_ki", int(value))
		self.sd_pid3_ki.set_value(value)

	def sd_pid3_kd_changed(self, widget, value):
		print("/dev/pid3_kd", int(value))
		liboscimp_fpga.add_const_set_offset("/dev/pid3_kd", int(value))
		self.sb_pid3_kd.set_value(value)

	def sb_pid3_kd_changed(self, widget, value):
		print("/dev/pid3_kd", int(value))
		liboscimp_fpga.add_const_set_offset("/dev/pid3_kd", int(value))
		self.sd_pid3_kd.set_value(value)

	def sd_pid3_setpoint_changed(self, widget, value):
		print("/dev/pid3_setpoint", int(value))
		liboscimp_fpga.add_const_set_offset("/dev/pid3_setpoint", int(value))
		self.sb_pid3_setpoint.set_value(value)

	def sb_pid3_setpoint_changed(self, widget, value):
		print("/dev/pid3_setpoint", int(value))
		liboscimp_fpga.add_const_set_offset("/dev/pid3_setpoint", int(value))
		self.sd_pid3_setpoint.set_value(value)

	def sd_pid3_sign_changed(self, widget, value):
		print("/dev/pid3_sign", int(value))
		liboscimp_fpga.add_const_set_offset("/dev/pid3_sign", int(value))
		self.sb_pid3_sign.set_value(value)

	def sb_pid3_sign_changed(self, widget, value):
		print("/dev/pid3_sign", int(value))
		liboscimp_fpga.add_const_set_offset("/dev/pid3_sign", int(value))
		self.sd_pid3_sign.set_value(value)

	def sd_pid3_rst_int_changed(self, widget, value):
		print("/dev/pid3_rst_int", int(value))
		liboscimp_fpga.add_const_set_offset("/dev/pid3_rst_int", int(value))
		self.sb_pid3_rst_int.set_value(value)

	def sb_pid3_rst_int_changed(self, widget, value):
		print("/dev/pid3_rst_int", int(value))
		liboscimp_fpga.add_const_set_offset("/dev/pid3_rst_int", int(value))
		self.sd_pid3_rst_int.set_value(value)

	def sd_mod_amp_dds_ampl_changed(self, widget, value):
		print("/dev/mod_amp_dds_ampl", int(value))
		liboscimp_fpga.add_const_set_offset("/dev/mod_amp_dds_ampl", int(value))
		self.sb_mod_amp_dds_ampl.set_value(value)

	def sb_mod_amp_dds_ampl_changed(self, widget, value):
		print("/dev/mod_amp_dds_ampl", int(value))
		liboscimp_fpga.add_const_set_offset("/dev/mod_amp_dds_ampl", int(value))
		self.sd_mod_amp_dds_ampl.set_value(value)
	...
	def sd_mod_amp_dds_nco_changed(self, widget, value):
		print("/dev/mod_amp_dds_nco", 125000000, int(value), 32, 0, int(self.cb_pinc_mod_amp_dds_nco.get_value()), int(self.cb_poff_mod_amp_dds_nco.get_value()))
		liboscimp_fpga.nco_counter_send_conf("/dev/mod_amp_dds_nco", 125000000, int(value), 32, 0, int(self.cb_pinc_mod_amp_dds_nco.get_value()), int(self.cb_poff_mod_amp_dds_nco.get_value()))
		self.sb_mod_amp_dds_nco.set_value(value)

	def sb_mod_amp_dds_nco_changed(self, widget, value):
		print("/dev/mod_amp_dds_nco", 125000000, int(value), 32, 0, int(self.cb_pinc_mod_amp_dds_nco.get_value()), int(self.cb_poff_mod_amp_dds_nco.get_value()))
		liboscimp_fpga.nco_counter_send_conf("/dev/mod_amp_dds_nco", 125000000, int(value), 32, 0, int(self.cb_pinc_mod_amp_dds_nco.get_value()), int(self.cb_poff_mod_amp_dds_nco.get_value()))
		self.sd_mod_amp_dds_nco.set_value(value)

	def cb_mod_amp_dds_nco_changed(self, widget, value):
		print("/dev/mod_amp_dds_nco", 125000000, int(self.sb_mod_amp_dds_nco.get_value()), 32, 0, int(self.cb_pinc_mod_amp_dds_nco.get_value()), int(self.cb_poff_mod_amp_dds_nco.get_value()))
		liboscimp_fpga.nco_counter_send_conf("/dev/mod_amp_dds_nco", 125000000, int(self.sb_mod_amp_dds_nco.get_value()), 32, 0, int(self.cb_pinc_mod_amp_dds_nco.get_value()), int(self.cb_poff_mod_amp_dds_nco.get_value()))
...
start(MyApp, address="0.0.0.0", port=80, title="demod_pid_vco_amp_mod_pid_only_webserver")
