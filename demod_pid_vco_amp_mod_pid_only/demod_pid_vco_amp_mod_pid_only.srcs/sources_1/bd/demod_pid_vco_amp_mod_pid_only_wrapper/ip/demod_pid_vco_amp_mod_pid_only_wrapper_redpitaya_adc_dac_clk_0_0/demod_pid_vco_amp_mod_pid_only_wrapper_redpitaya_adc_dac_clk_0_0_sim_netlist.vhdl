...
entity demod_pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0_redpitaya_adc_dac_clk is
  port (
  ...
  attribute ORIG_REF_NAME of demod_pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0_redpitaya_adc_dac_clk : entity is "redpitaya_adc_dac_clk";
end demod_pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0_redpitaya_adc_dac_clk;

architecture STRUCTURE of demod_pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0_redpitaya_adc_dac_clk is
...
entity demod_pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0 is
  ...
  attribute NotValidForBitStream of demod_pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of demod_pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0 : entity is "demod_pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0,redpitaya_adc_dac_clk,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of demod_pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of demod_pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0 : entity is "redpitaya_adc_dac_clk,Vivado 2016.4";
end demod_pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0;

architecture STRUCTURE of demod_pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0 is
begin
inst: entity work.demod_pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0_redpitaya_adc_dac_clk
     port map (
