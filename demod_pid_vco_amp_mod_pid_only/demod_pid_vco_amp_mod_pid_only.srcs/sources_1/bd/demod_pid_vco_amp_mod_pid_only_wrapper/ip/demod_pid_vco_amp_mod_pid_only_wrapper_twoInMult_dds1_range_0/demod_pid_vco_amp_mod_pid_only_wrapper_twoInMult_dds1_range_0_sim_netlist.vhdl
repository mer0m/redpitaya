...
--               /home/bma/git/fpga_design/redpitaya/demod_pid_vco_amp_mod_pid_only/demod_pid_vco_amp_mod_pid_only.srcs/sources_1/bd/demod_pid_vco_amp_mod_pid_only_wrapper/ip/demod_pid_vco_amp_mod_pid_only_wrapper_twoInMult_dds1_range_0/demod_pid_vco_amp_mod_pid_only_wrapper_twoInMult_dds1_range_0_sim_netlist.vhdl
...
entity demod_pid_vco_amp_mod_pid_only_wrapper_twoInMult_dds1_range_0_twoInMult is
  port (
  ...
  attribute ORIG_REF_NAME of demod_pid_vco_amp_mod_pid_only_wrapper_twoInMult_dds1_range_0_twoInMult : entity is "twoInMult";
end demod_pid_vco_amp_mod_pid_only_wrapper_twoInMult_dds1_range_0_twoInMult;

architecture STRUCTURE of demod_pid_vco_amp_mod_pid_only_wrapper_twoInMult_dds1_range_0_twoInMult is
...
entity demod_pid_vco_amp_mod_pid_only_wrapper_twoInMult_dds1_range_0 is
  ...
  attribute NotValidForBitStream of demod_pid_vco_amp_mod_pid_only_wrapper_twoInMult_dds1_range_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of demod_pid_vco_amp_mod_pid_only_wrapper_twoInMult_dds1_range_0 : entity is "demod_pid_vco_amp_mod_pid_only_wrapper_twoInMult_dds1_range_0,twoInMult,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of demod_pid_vco_amp_mod_pid_only_wrapper_twoInMult_dds1_range_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of demod_pid_vco_amp_mod_pid_only_wrapper_twoInMult_dds1_range_0 : entity is "twoInMult,Vivado 2016.4";
end demod_pid_vco_amp_mod_pid_only_wrapper_twoInMult_dds1_range_0;

architecture STRUCTURE of demod_pid_vco_amp_mod_pid_only_wrapper_twoInMult_dds1_range_0 is
  signal \^data1_clk_i\ : STD_LOGIC;
begin
  \^data1_clk_i\ <= data1_clk_i;
  data_clk_o <= \^data1_clk_i\;
U0: entity work.demod_pid_vco_amp_mod_pid_only_wrapper_twoInMult_dds1_range_0_twoInMult
     port map (
      data1_clk_i => \^data1_clk_i\,
