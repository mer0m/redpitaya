...
-- Date        : Wed May 16 11:37:37 2018
-- Host        : ux305 running 64-bit Debian GNU/Linux testing/unstable
-- Command     : write_vhdl -force -mode funcsim
--               /home/bma/git/fpga_design/redpitaya/demod_pid_vco_amp_mod_pid_only/demod_pid_vco_amp_mod_pid_only.srcs/sources_1/bd/demod_pid_vco_amp_mod_pid_only_wrapper/ip/demod_pid_vco_amp_mod_pid_only_wrapper_pid1_0/demod_pid_vco_amp_mod_pid_only_wrapper_pid1_0_sim_netlist.vhdl
-- Design      : demod_pid_vco_amp_mod_pid_only_wrapper_pid1_0
...
entity demod_pid_vco_amp_mod_pid_only_wrapper_pid1_0_red_pitaya_pidv3_logic is
  port (
  ...
  attribute ORIG_REF_NAME of demod_pid_vco_amp_mod_pid_only_wrapper_pid1_0_red_pitaya_pidv3_logic : entity is "red_pitaya_pidv3_logic";
end demod_pid_vco_amp_mod_pid_only_wrapper_pid1_0_red_pitaya_pidv3_logic;

architecture STRUCTURE of demod_pid_vco_amp_mod_pid_only_wrapper_pid1_0_red_pitaya_pidv3_logic is
  ...
  signal I_sum_s_i_39_n_0 : STD_LOGIC;
  ...
  signal I_sum_s_i_40_n_0 : STD_LOGIC;
  ...
  signal \I_temp_s[31]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \I_temp_s[19]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \I_temp_s[20]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \I_temp_s[21]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \I_temp_s[22]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \I_temp_s[23]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \I_temp_s[24]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \I_temp_s[25]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \I_temp_s[26]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \I_temp_s[27]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \I_temp_s[28]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \I_temp_s[29]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \I_temp_s[30]_i_1\ : label is "soft_lutpair5";
...
I_sum_s: unisim.vcomponents.DSP48E1
    generic map(
      ...
      B(17 downto 0) => ki_i(17 downto 0),
...
I_sum_s_i_2: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 2) => B"00",
      DI(1) => I_sum_s_i_39_n_0,
      DI(0) => I_sum_s_i_40_n_0,
      O(3) => NLW_I_sum_s_i_2_O_UNCONNECTED(3),
      O(2 downto 0) => A(14 downto 12),
      S(3) => '0',
      S(2) => I_sum_s_i_41_n_0,
      S(1) => I_sum_s_i_42_n_0,
      S(0) => I_sum_s_i_43_n_0
    );
...
I_sum_s_i_3: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => I_sum_s_i_44_n_0,
      DI(2) => I_sum_s_i_45_n_0,
      DI(1) => I_sum_s_i_46_n_0,
      DI(0) => I_sum_s_i_47_n_0,
      O(3 downto 0) => A(11 downto 8),
      S(3) => I_sum_s_i_48_n_0,
      S(2) => I_sum_s_i_49_n_0,
      S(1) => I_sum_s_i_50_n_0,
      S(0) => I_sum_s_i_51_n_0
    );
...
I_sum_s_i_39: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
I_sum_s_i_4: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => I_sum_s_i_52_n_0,
      DI(2) => I_sum_s_i_53_n_0,
      DI(1) => I_sum_s_i_54_n_0,
      DI(0) => I_sum_s_i_55_n_0,
      O(3 downto 0) => A(7 downto 4),
      S(3) => I_sum_s_i_56_n_0,
      S(2) => I_sum_s_i_57_n_0,
      S(1) => I_sum_s_i_58_n_0,
      S(0) => I_sum_s_i_59_n_0
    );
I_sum_s_i_40: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
I_sum_s_i_41: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
I_sum_s_i_42: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
I_sum_s_i_44: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
I_sum_s_i_45: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
I_sum_s_i_48: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
I_sum_s_i_49: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
I_sum_s_i_5: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '1',
      DI(3) => I_sum_s_i_60_n_0,
      DI(2) => I_sum_s_i_61_n_0,
      DI(1) => I_sum_s_i_62_n_0,
      DI(0) => I_sum_s_i_63_n_0,
      O(3 downto 0) => A(3 downto 0),
      S(3) => I_sum_s_i_64_n_0,
      S(2) => I_sum_s_i_65_n_0,
      S(1) => I_sum_s_i_66_n_0,
      S(0) => I_sum_s_i_67_n_0
    );
...
I_sum_s_i_52: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
I_sum_s_i_53: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
I_sum_s_i_56: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
I_sum_s_i_57: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
I_sum_s_i_60: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
I_sum_s_i_61: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
I_sum_s_i_64: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
I_sum_s_i_65: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\I_temp_s[31]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\I_temp_s[31]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"AE"
    )
        port map (
      ...
      I1 => I_sum_s_n_74,
      I2 => I_temp_s1,
      O => \I_temp_s[31]_i_2_n_0\
    );
\I_temp_s[32]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity demod_pid_vco_amp_mod_pid_only_wrapper_pid1_0_red_pitaya_pidv3 is
  port (
    data_o : out STD_LOGIC_VECTOR ( 13 downto 0 );
    data_en_o : out STD_LOGIC;
    data_i : in STD_LOGIC_VECTOR ( 13 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of demod_pid_vco_amp_mod_pid_only_wrapper_pid1_0_red_pitaya_pidv3 : entity is "red_pitaya_pidv3";
end demod_pid_vco_amp_mod_pid_only_wrapper_pid1_0_red_pitaya_pidv3;

architecture STRUCTURE of demod_pid_vco_amp_mod_pid_only_wrapper_pid1_0_red_pitaya_pidv3 is
begin
red_pitaya_pidv3Logic: entity work.demod_pid_vco_amp_mod_pid_only_wrapper_pid1_0_red_pitaya_pidv3_logic
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity demod_pid_vco_amp_mod_pid_only_wrapper_pid1_0 is
  port (
    data_i : in STD_LOGIC_VECTOR ( 13 downto 0 );
    data_en_i : in STD_LOGIC;
    data_clk_i : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of demod_pid_vco_amp_mod_pid_only_wrapper_pid1_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of demod_pid_vco_amp_mod_pid_only_wrapper_pid1_0 : entity is "demod_pid_vco_amp_mod_pid_only_wrapper_pid1_0,red_pitaya_pidv3,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of demod_pid_vco_amp_mod_pid_only_wrapper_pid1_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of demod_pid_vco_amp_mod_pid_only_wrapper_pid1_0 : entity is "red_pitaya_pidv3,Vivado 2016.4";
end demod_pid_vco_amp_mod_pid_only_wrapper_pid1_0;

architecture STRUCTURE of demod_pid_vco_amp_mod_pid_only_wrapper_pid1_0 is
...
U0: entity work.demod_pid_vco_amp_mod_pid_only_wrapper_pid1_0_red_pitaya_pidv3
     port map (
      data_clk_i => \^data_clk_i\,
      data_en_i => data_en_i,
      data_en_o => data_en_o,
