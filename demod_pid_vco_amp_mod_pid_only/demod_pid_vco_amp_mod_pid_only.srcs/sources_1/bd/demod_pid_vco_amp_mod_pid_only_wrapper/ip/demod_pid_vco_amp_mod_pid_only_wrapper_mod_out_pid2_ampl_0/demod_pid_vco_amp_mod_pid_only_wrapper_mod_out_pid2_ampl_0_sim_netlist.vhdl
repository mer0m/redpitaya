...
-- Date        : Wed May 16 11:55:18 2018
-- Host        : ux305 running 64-bit Debian GNU/Linux testing/unstable
-- Command     : write_vhdl -force -mode funcsim
--               /home/bma/git/fpga_design/redpitaya/demod_pid_vco_amp_mod_pid_only/demod_pid_vco_amp_mod_pid_only.srcs/sources_1/bd/demod_pid_vco_amp_mod_pid_only_wrapper/ip/demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0/demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0_sim_netlist.vhdl
-- Design      : demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0
...
entity demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0_add_const_handComm is
  port (
  ...
  attribute ORIG_REF_NAME of demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0_add_const_handComm : entity is "add_const_handComm";
end demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0_add_const_handComm;

architecture STRUCTURE of demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0_add_const_handComm is
  ...
  signal \readdata_s[13]_i_3_n_0\ : STD_LOGIC;
  signal \readdata_s[13]_i_4_n_0\ : STD_LOGIC;
  signal \readdata_s[13]_i_5_n_0\ : STD_LOGIC;
  signal \readdata_s[13]_i_6_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \readdata_s[13]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \readdata_s[13]_i_3\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \readdata_s[13]_i_4\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \readdata_s[13]_i_5\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \readdata_s[13]_i_6\ : label is "soft_lutpair1";
begin
...
\readdata_s[13]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAA8A8AAAA08A80"
    )
        port map (
...
\readdata_s[13]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\readdata_s[13]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
\readdata_s[13]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFBF0080"
    )
        port map (
...
\readdata_s[13]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFBF0080"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0_add_const_logic is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0_add_const_logic : entity is "add_const_logic";
end demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0_add_const_logic;

architecture STRUCTURE of demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0_add_const_logic is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0_wb_add_const is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0_wb_add_const : entity is "wb_add_const";
end demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0_wb_add_const;

architecture STRUCTURE of demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0_wb_add_const is
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0_add_const is
  port (
    s00_axi_aclk : in STD_LOGIC;
    s00_axi_reset : in STD_LOGIC;
  ...
  attribute C_S00_AXI_ADDR_WIDTH of demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0_add_const : entity is 4;
  attribute C_S00_AXI_DATA_WIDTH : integer;
  attribute C_S00_AXI_DATA_WIDTH of demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0_add_const : entity is 32;
  attribute DATA_IN_SIZE : integer;
  attribute DATA_IN_SIZE of demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0_add_const : entity is 14;
  attribute DATA_OUT_SIZE : integer;
  attribute DATA_OUT_SIZE of demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0_add_const : entity is 14;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0_add_const : entity is "add_const";
  attribute add_val : integer;
  attribute add_val of demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0_add_const : entity is 0;
  attribute format : string;
  attribute format of demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0_add_const : entity is "unsigned";
  attribute id : integer;
  attribute id of demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0_add_const : entity is 1;
end demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0_add_const;

architecture STRUCTURE of demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0_add_const is
...
add_constHandComm: entity work.demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0_add_const_handComm
     port map (
      D(13 downto 1) => p_0_in(13 downto 1),
...
add_constLogic: entity work.demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0_add_const_logic
     port map (
      Q(13 downto 0) => offset_s(13 downto 0),
      data_clk_i => \^data_clk_i\,
      data_en_i => data_en_i,
...
wb_add_const_inst: entity work.demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0_wb_add_const
     port map (
      D(13 downto 1) => p_0_in(13 downto 1),
      D(0) => add_constHandComm_n_18,
      E(0) => add_constHandComm_n_19,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0 is
  port (
    s00_axi_aclk : in STD_LOGIC;
    s00_axi_reset : in STD_LOGIC;
    s00_axi_awaddr : in STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute NotValidForBitStream of demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0 : entity is "demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0,add_const,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0 : entity is "add_const,Vivado 2016.4";
end demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0;

architecture STRUCTURE of demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0 is
  attribute C_S00_AXI_ADDR_WIDTH : integer;
...
begin
U0: entity work.demod_pid_vco_amp_mod_pid_only_wrapper_mod_out_pid2_ampl_0_add_const
     port map (
      data_clk_i => data_clk_i,
