...
HD_PWD='/home/bma/git/fpga_design/redpitaya/demod_pid_vco_amp_mod_pid_only/demod_pid_vco_amp_mod_pid_only.runs/demod_pid_vco_amp_mod_pid_only_wrapper_pid2_kd_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log demod_pid_vco_amp_mod_pid_only_wrapper_pid2_kd_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source demod_pid_vco_amp_mod_pid_only_wrapper_pid2_kd_0.tcl
