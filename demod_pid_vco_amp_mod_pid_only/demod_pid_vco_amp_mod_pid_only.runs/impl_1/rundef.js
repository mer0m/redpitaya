...
ISEStep( "vivado",
         "-log demod_pid_vco_amp_mod_pid_only_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source demod_pid_vco_amp_mod_pid_only_wrapper.tcl -notrace" );
