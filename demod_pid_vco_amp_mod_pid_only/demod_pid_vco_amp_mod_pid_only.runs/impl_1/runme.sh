...
HD_PWD='/home/bma/git/fpga_design/redpitaya/demod_pid_vco_amp_mod_pid_only/demod_pid_vco_amp_mod_pid_only.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log demod_pid_vco_amp_mod_pid_only_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source demod_pid_vco_amp_mod_pid_only_wrapper.tcl -notrace
