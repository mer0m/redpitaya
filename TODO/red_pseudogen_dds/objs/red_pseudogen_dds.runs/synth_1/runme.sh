...
HD_PWD='/home/gwe/projets/oscimp/fpga_dev/redpitaya/red_pseudogen_dds/objs/red_pseudogen_dds.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_red_pseudogen_dds.vds -m64 -mode batch -messageDb vivado.pb -notrace -source top_red_pseudogen_dds.tcl
