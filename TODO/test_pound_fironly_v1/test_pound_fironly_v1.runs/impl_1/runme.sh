...
HD_PWD='/home/pyb/git/pyb/fpga/redpitaya/test_pound_fironly_v1/test_pound_fironly_v1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_pound_fironly_v1_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source test_pound_fironly_v1_wrapper.tcl -notrace
