...
#
# Generated by export_simulation on Fri Dec 02 16:09:48 CET 2016
#
################################################################################
...
switch to the './test_pound_fironly_v1.sh' script.

./test_pound_fironly_v1.sh -reset_run
...
./test_pound_fironly_v1.sh -noclean_files

For more information on the script, please type './test_pound_fironly_v1.sh -help'.
