...
Entity axi_red_pitaya_pidv2 is
	generic(
...
end entity axi_red_pitaya_pidv2;


Architecture axi_red_pitaya_pidv2_1 of axi_red_pitaya_pidv2 is
...
begin
	...
	begin
			...
			int_rst_s <= int_rst_s;
				...
				when REG_KP => 
					kp_s <= axi_writedata(P_SIZE-1 downto 0);
				when REG_KI => 
					ki_s <= axi_writedata(I_SIZE-1 downto 0);
				when REG_KD =>
					kd_s <= axi_writedata(D_SIZE-1 downto 0);
				when REG_RST_INT =>
        ...
        begin
				...
				when REG_KP => 
					readdata_s <= (31 downto P_SIZE => '0')&kp_s;
				when REG_KI => 
					readdata_s <= (31 downto I_SIZE => '0')&ki_s;
				when REG_KD =>
					readdata_s <= (31 downto D_SIZE => '0')&kd_s;
				when REG_RST_INT =>
...
end Architecture axi_red_pitaya_pidv2_1;
