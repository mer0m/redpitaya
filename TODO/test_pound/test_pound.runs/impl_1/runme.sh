...
HD_PWD='/home/bma/git/fpga_design/redpitaya/TODO/test_pound/test_pound.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_pound_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_pound_wrapper.tcl -notrace
