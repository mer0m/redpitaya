...
switch to the './test_pound_FIR.sh' script.

./test_pound_FIR.sh -reset_run
...
./test_pound_FIR.sh -noclean_files

For more information on the script, please type './test_pound_FIR.sh -help'.
