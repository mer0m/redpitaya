...
HD_PWD='/home/bma/Documents/BPT_sync/Work/5-ED_SPIM/Work/git/fpga_design/redpitaya/test_pound_FIR/test_pound_FIR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_pound_FIR_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_pound_FIR_wrapper.tcl -notrace
