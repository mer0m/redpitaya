...
HD_PWD='/home/bma/Documents/BPT_sync/Work/5-ED_SPIM/Work/git/fpga_design/redpitaya/test_pound_FIR/test_pound_FIR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_pound_FIR_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_pound_FIR_wrapper.tcl
