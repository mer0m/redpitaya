...
HD_PWD='/home/bma/git/fpga_design/redpitaya/iq_demod_only/iq_demod_only.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log iq_demod_only_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source iq_demod_only_wrapper.tcl -notrace
