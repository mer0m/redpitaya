...
HD_PWD='/home/bma/git/fpga_design/redpitaya/iq_demod_only/iq_demod_only.runs/iq_demod_only_wrapper_mixer_sin_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iq_demod_only_wrapper_mixer_sin_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iq_demod_only_wrapper_mixer_sin_0_0.tcl
