...
-- Date        : Thu Apr 20 08:15:10 2017
-- Host        : ux305 running 64-bit Debian GNU/Linux 9.0 (stretch)
-- Command     : write_vhdl -force -mode funcsim
--               /home/bma/git/fpga_design/redpitaya/iq_demod_only/iq_demod_only.srcs/sources_1/bd/iq_demod_only_wrapper/ip/iq_demod_only_wrapper_twoInMult_0_0/iq_demod_only_wrapper_twoInMult_0_0_sim_netlist.vhdl
-- Design      : iq_demod_only_wrapper_twoInMult_0_0
...
entity iq_demod_only_wrapper_twoInMult_0_0_twoInMult is
  port (
  ...
  attribute ORIG_REF_NAME of iq_demod_only_wrapper_twoInMult_0_0_twoInMult : entity is "twoInMult";
end iq_demod_only_wrapper_twoInMult_0_0_twoInMult;

architecture STRUCTURE of iq_demod_only_wrapper_twoInMult_0_0_twoInMult is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity iq_demod_only_wrapper_twoInMult_0_0 is
  port (
    data1_i : in STD_LOGIC_VECTOR ( 13 downto 0 );
    data1_en_i : in STD_LOGIC;
    data1_clk_i : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of iq_demod_only_wrapper_twoInMult_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of iq_demod_only_wrapper_twoInMult_0_0 : entity is "iq_demod_only_wrapper_twoInMult_0_0,twoInMult,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of iq_demod_only_wrapper_twoInMult_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of iq_demod_only_wrapper_twoInMult_0_0 : entity is "twoInMult,Vivado 2016.4";
end iq_demod_only_wrapper_twoInMult_0_0;

architecture STRUCTURE of iq_demod_only_wrapper_twoInMult_0_0 is
  signal \^data1_clk_i\ : STD_LOGIC;
begin
  \^data1_clk_i\ <= data1_clk_i;
  data_clk_o <= \^data1_clk_i\;
U0: entity work.iq_demod_only_wrapper_twoInMult_0_0_twoInMult
     port map (
      data1_clk_i => \^data1_clk_i\,
