...
HD_PWD='/home/bma/git/fpga_design/redpitaya/pid_vco/pid_vco.runs/pid_vco_wrapper_pid_ki_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pid_vco_wrapper_pid_ki_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pid_vco_wrapper_pid_ki_0.tcl
