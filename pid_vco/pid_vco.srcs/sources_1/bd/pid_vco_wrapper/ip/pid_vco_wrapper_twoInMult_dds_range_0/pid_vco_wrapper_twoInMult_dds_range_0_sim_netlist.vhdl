...
-- Date        : Tue Apr 11 10:27:49 2017
-- Host        : ux305 running 64-bit Debian GNU/Linux 9.0 (stretch)
-- Command     : write_vhdl -force -mode funcsim
--               /home/bma/git/fpga_design/redpitaya/pid_vco/pid_vco.srcs/sources_1/bd/pid_vco_wrapper/ip/pid_vco_wrapper_twoInMult_dds_range_0/pid_vco_wrapper_twoInMult_dds_range_0_sim_netlist.vhdl
-- Design      : pid_vco_wrapper_twoInMult_dds_range_0
...
entity pid_vco_wrapper_twoInMult_dds_range_0_twoInMult is
  port (
  ...
  attribute ORIG_REF_NAME of pid_vco_wrapper_twoInMult_dds_range_0_twoInMult : entity is "twoInMult";
end pid_vco_wrapper_twoInMult_dds_range_0_twoInMult;

architecture STRUCTURE of pid_vco_wrapper_twoInMult_dds_range_0_twoInMult is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity pid_vco_wrapper_twoInMult_dds_range_0 is
  port (
    data1_i : in STD_LOGIC_VECTOR ( 13 downto 0 );
    data1_en_i : in STD_LOGIC;
    data1_clk_i : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of pid_vco_wrapper_twoInMult_dds_range_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of pid_vco_wrapper_twoInMult_dds_range_0 : entity is "pid_vco_wrapper_twoInMult_dds_range_0,twoInMult,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of pid_vco_wrapper_twoInMult_dds_range_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of pid_vco_wrapper_twoInMult_dds_range_0 : entity is "twoInMult,Vivado 2016.4";
end pid_vco_wrapper_twoInMult_dds_range_0;

architecture STRUCTURE of pid_vco_wrapper_twoInMult_dds_range_0 is
  signal \^data1_clk_i\ : STD_LOGIC;
begin
  \^data1_clk_i\ <= data1_clk_i;
  data_clk_o <= \^data1_clk_i\;
U0: entity work.pid_vco_wrapper_twoInMult_dds_range_0_twoInMult
     port map (
      data1_clk_i => \^data1_clk_i\,
