...
class MyApp(App):
	...
	def main(self):
		...
		self.sd_pid_kp = gui.SpinBox(0, -8192, 8191, 1, width="60%", margin="10px")
		...
		self.sd_pid_ki = gui.SpinBox(0, -8192, 8191, 1, width="60%", margin="10px")
		...
		self.sd_pid_kd = gui.SpinBox(0, -8192, 8191, 1, width="60%", margin="10px")
		...
		self.sd_pid_rst_int = gui.SpinBox(0, -8192, 8191, 1, width="60%", margin="10px")
		...
		self.sd_pid_sign = gui.SpinBox(0, -8192, 8191, 1, width="60%", margin="10px")
		...
		self.sd_pid_setpoint = gui.SpinBox(0, -8192, 8191, 1, width="60%", margin="10px")
