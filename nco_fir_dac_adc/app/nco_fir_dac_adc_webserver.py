...
class MyApp(App):
	...
	def sd_pinc_nco1_changed(self, widget, value):
		...
		print("/dev/nco1", samp_freq, int(value), 40, int(self.sb_poff_nco1.get_value()), int(self.cb_pinc_nco1.get_value()), int(self.cb_poff_nco1.get_value()))
		liboscimp_fpga.nco_counter_send_conf("/dev/nco1", samp_freq, ctypes.c_double(int(value)), 40, int(self.sb_poff_nco1.get_value()), int(self.cb_pinc_nco1.get_value()), int(self.cb_poff_nco1.get_value()))
		self.sb_pinc_nco1.set_value(int(value))
	...
	def sd_pinc_nco2_changed(self, widget, value):
		...
		print("/dev/nco2", samp_freq, int(value), 40, int(self.sb_poff_nco2.get_value()), int(self.cb_pinc_nco2.get_value()), int(self.cb_poff_nco2.get_value()))
		liboscimp_fpga.nco_counter_send_conf("/dev/nco2", samp_freq, ctypes.c_double(int(value)), 40, int(self.sb_poff_nco2.get_value()), int(self.cb_pinc_nco2.get_value()), int(self.cb_poff_nco2.get_value()))
		self.sb_pinc_nco2.set_value(int(value))
