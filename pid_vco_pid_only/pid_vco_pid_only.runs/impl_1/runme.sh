...
HD_PWD='/home/bma/git/fpga_design/redpitaya/pid_vco_pid_only/pid_vco_pid_only.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pid_vco_pid_only_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pid_vco_pid_only_wrapper.tcl -notrace
