...
ISEStep( "vivado",
         "-log dds_gnuradio_wrapper_redpitaya_adc_dac_clk_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dds_gnuradio_wrapper_redpitaya_adc_dac_clk_0_0.tcl" );
