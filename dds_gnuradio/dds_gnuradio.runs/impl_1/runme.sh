...
HD_PWD='/home/bma/git/fpga_design/redpitaya/dds_gnuradio/dds_gnuradio.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dds_gnuradio_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dds_gnuradio_wrapper.tcl -notrace
