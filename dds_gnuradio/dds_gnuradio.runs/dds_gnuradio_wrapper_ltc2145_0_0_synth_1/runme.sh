...
HD_PWD='/home/bma/git/fpga_design/redpitaya/dds_gnuradio/dds_gnuradio.runs/dds_gnuradio_wrapper_ltc2145_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dds_gnuradio_wrapper_ltc2145_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dds_gnuradio_wrapper_ltc2145_0_0.tcl
