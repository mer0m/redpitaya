...
-- Date        : Thu Mar 30 09:03:29 2017
-- Host        : ux305 running 64-bit Debian GNU/Linux 9.0 (stretch)
-- Command     : write_vhdl -force -mode funcsim
--               /home/bma/git/fpga_design/redpitaya/dds_gnuradio/dds_gnuradio.srcs/sources_1/bd/dds_gnuradio_wrapper/ip/dds_gnuradio_wrapper_twoInMult_0_0/dds_gnuradio_wrapper_twoInMult_0_0_sim_netlist.vhdl
-- Design      : dds_gnuradio_wrapper_twoInMult_0_0
...
entity dds_gnuradio_wrapper_twoInMult_0_0_twoInMult is
  port (
  ...
  attribute ORIG_REF_NAME of dds_gnuradio_wrapper_twoInMult_0_0_twoInMult : entity is "twoInMult";
end dds_gnuradio_wrapper_twoInMult_0_0_twoInMult;

architecture STRUCTURE of dds_gnuradio_wrapper_twoInMult_0_0_twoInMult is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity dds_gnuradio_wrapper_twoInMult_0_0 is
  port (
    data1_i : in STD_LOGIC_VECTOR ( 13 downto 0 );
    data1_en_i : in STD_LOGIC;
    data1_clk_i : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of dds_gnuradio_wrapper_twoInMult_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of dds_gnuradio_wrapper_twoInMult_0_0 : entity is "dds_gnuradio_wrapper_twoInMult_0_0,twoInMult,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of dds_gnuradio_wrapper_twoInMult_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of dds_gnuradio_wrapper_twoInMult_0_0 : entity is "twoInMult,Vivado 2016.4";
end dds_gnuradio_wrapper_twoInMult_0_0;

architecture STRUCTURE of dds_gnuradio_wrapper_twoInMult_0_0 is
  signal \^data1_clk_i\ : STD_LOGIC;
begin
  \^data1_clk_i\ <= data1_clk_i;
  data_clk_o <= \^data1_clk_i\;
U0: entity work.dds_gnuradio_wrapper_twoInMult_0_0_twoInMult
     port map (
      data1_clk_i => \^data1_clk_i\,
