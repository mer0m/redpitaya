...
entity double_iq_pid_vco_dds1_offset_0_add_constReal_handComm is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity double_iq_pid_vco_dds1_offset_0_add_constReal_logic is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity double_iq_pid_vco_dds1_offset_0_add_constReal_synchronizer_vector is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity double_iq_pid_vco_dds1_offset_0_wb_add_constReal is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity double_iq_pid_vco_dds1_offset_0_add_constReal is
  port (
    s00_axi_aclk : in STD_LOGIC;
    s00_axi_reset : in STD_LOGIC;
  ...
  attribute C_S00_AXI_ADDR_WIDTH of double_iq_pid_vco_dds1_offset_0_add_constReal : entity is 4;
  attribute C_S00_AXI_DATA_WIDTH : integer;
  attribute C_S00_AXI_DATA_WIDTH of double_iq_pid_vco_dds1_offset_0_add_constReal : entity is 32;
  ...
  attribute format of double_iq_pid_vco_dds1_offset_0_add_constReal : entity is "signed";
  attribute id : integer;
  attribute id of double_iq_pid_vco_dds1_offset_0_add_constReal : entity is 1;
end double_iq_pid_vco_dds1_offset_0_add_constReal;

architecture STRUCTURE of double_iq_pid_vco_dds1_offset_0_add_constReal is
...
add_constRealHandComm: entity work.double_iq_pid_vco_dds1_offset_0_add_constReal_handComm
     port map (
      E(0) => offset_s_0,
      addr_s(1 downto 0) => addr_s(1 downto 0),
...
add_constRealLogic: entity work.double_iq_pid_vco_dds1_offset_0_add_constReal_logic
     port map (
      data_clk_i => \^data_clk_i\,
      data_en_i => data_en_i,
      data_en_o => data_en_o,
...
offset_syn: entity work.double_iq_pid_vco_dds1_offset_0_add_constReal_synchronizer_vector
     port map (
      Q(13 downto 0) => offset_s(13 downto 0),
      data_clk_i => \^data_clk_i\,
      \out\(13 downto 0) => offset_sync_s(13 downto 0)
    );
wb_add_constReal_inst: entity work.double_iq_pid_vco_dds1_offset_0_wb_add_constReal
     port map (
      E(0) => offset_l_s,
      Q(13 downto 0) => offset_s(13 downto 0),
      addr_s(1 downto 0) => addr_s(1 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity double_iq_pid_vco_dds1_offset_0 is
  port (
    s00_axi_aclk : in STD_LOGIC;
    s00_axi_reset : in STD_LOGIC;
    s00_axi_awaddr : in STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute x_core_info of double_iq_pid_vco_dds1_offset_0 : entity is "add_constReal,Vivado 2019.2";
end double_iq_pid_vco_dds1_offset_0;

architecture STRUCTURE of double_iq_pid_vco_dds1_offset_0 is
  attribute C_S00_AXI_ADDR_WIDTH : integer;
...
begin
U0: entity work.double_iq_pid_vco_dds1_offset_0_add_constReal
     port map (
      data_clk_i => data_clk_i,
