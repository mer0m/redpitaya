...
architecture STRUCTURE of \double_iq_pid_vco_dataReal_to_ram_fast_0_dataReal_sync__xdcDup__3\ is
  ...
  attribute SOFT_HLUTNM of busy_d_s_i_1 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of start_s_i_1 : label is "soft_lutpair4";
  attribute ASYNC_REG_boolean : boolean;
  attribute ASYNC_REG_boolean of sync_stage1_s_reg : label is std.standard.true;
  attribute KEEP : string;
  attribute KEEP of sync_stage1_s_reg : label is "yes";
...
architecture STRUCTURE of double_iq_pid_vco_dataReal_to_ram_fast_0_dataReal_to_ram_handCom is
  ...
  attribute SOFT_HLUTNM of \ram_addr_s[8]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \readdata_s[31]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of start_o_i_1 : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of start_o_i_2 : label is "soft_lutpair14";
begin
...
\ram_addr_s[8]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
mem_reg: unisim.vcomponents.RAMB18E1
    generic map(
      ...
      WRITE_WIDTH_B => 18
        ...
        port map (
      ADDRARDADDR(13) => '1',
      ADDRARDADDR(12 downto 4) => Q(9 downto 1),
      ADDRARDADDR(3 downto 0) => B"1111",
      ADDRBWRADDR(13) => '1',
      ADDRBWRADDR(12 downto 4) => mem_reg_0(8 downto 0),
...
mem_reg: unisim.vcomponents.RAMB18E1
    generic map(
      ...
      ADDRARDADDR(3 downto 0) => B"1111",
      ADDRBWRADDR(13) => '1',
      ADDRBWRADDR(12 downto 4) => mem_reg_1(8 downto 0),
      ADDRBWRADDR(3 downto 0) => B"1111",
      CLKARDCLK => data2_clk_i,
      CLKBWRCLK => s00_axi_aclk,
      DIADI(15 downto 0) => data2_i(15 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity double_iq_pid_vco_dataReal_to_ram_fast_0_dataReal_to_ram_storage_1 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of double_iq_pid_vco_dataReal_to_ram_fast_0_dataReal_to_ram_storage_1 : entity is "dataReal_to_ram_storage";
end double_iq_pid_vco_dataReal_to_ram_fast_0_dataReal_to_ram_storage_1;

architecture STRUCTURE of double_iq_pid_vco_dataReal_to_ram_fast_0_dataReal_to_ram_storage_1 is
  signal \res_s[0]_0\ : STD_LOGIC_VECTOR ( 15 downto 0 );
  signal we_even_s : STD_LOGIC;
  signal NLW_mem_reg_DOADO_UNCONNECTED : STD_LOGIC_VECTOR ( 15 downto 0 );
  signal NLW_mem_reg_DOPADOP_UNCONNECTED : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal NLW_mem_reg_DOPBDOP_UNCONNECTED : STD_LOGIC_VECTOR ( 1 downto 0 );
...
mem_reg: unisim.vcomponents.RAMB18E1
    generic map(
      ...
      DOBDO(14) => mem_reg_0(7),
      DOBDO(13) => \res_s[0]_0\(13),
      DOBDO(12) => mem_reg_0(6),
      DOBDO(11) => \res_s[0]_0\(11),
      DOBDO(10) => mem_reg_0(5),
      DOBDO(9) => \res_s[0]_0\(9),
      DOBDO(8 downto 7) => mem_reg_0(4 downto 3),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity double_iq_pid_vco_dataReal_to_ram_fast_0_dataReal_to_ram_storage_2 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of double_iq_pid_vco_dataReal_to_ram_fast_0_dataReal_to_ram_storage_2 : entity is "dataReal_to_ram_storage";
end double_iq_pid_vco_dataReal_to_ram_fast_0_dataReal_to_ram_storage_2;

architecture STRUCTURE of double_iq_pid_vco_dataReal_to_ram_fast_0_dataReal_to_ram_storage_2 is
  signal \res_s[0]_0\ : STD_LOGIC_VECTOR ( 30 downto 17 );
  signal we_odd_s : STD_LOGIC;
  signal NLW_mem_reg_DOADO_UNCONNECTED : STD_LOGIC_VECTOR ( 15 downto 0 );
  signal NLW_mem_reg_DOPADOP_UNCONNECTED : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal NLW_mem_reg_DOPBDOP_UNCONNECTED : STD_LOGIC_VECTOR ( 1 downto 0 );
...
architecture STRUCTURE of double_iq_pid_vco_dataReal_to_ram_fast_0_dataReal_to_ram_subtop is
  ...
  signal sample_cpt_s_reg : STD_LOGIC_VECTOR ( 9 downto 1 );
  signal \sample_cpt_s_reg__0\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal start_acq2_s_reg_n_0 : STD_LOGIC;
  signal sync_start_n_0 : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \busy_s_i_2__0\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \sample_cpt_s[1]_i_1__0\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \sample_cpt_s[2]_i_1__0\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \sample_cpt_s[3]_i_1__0\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \sample_cpt_s[4]_i_1__0\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \sample_cpt_s[7]_i_1__0\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \sample_cpt_s[8]_i_1__0\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \sample_cpt_s[9]_i_2__0\ : label is "soft_lutpair6";
begin
...
\half_axi_bits.ram_even\: entity work.double_iq_pid_vco_dataReal_to_ram_fast_0_dataReal_to_ram_storage
     port map (
      D(5) => D(14),
      D(4) => D(10),
      ...
      Q(9 downto 1) => sample_cpt_s_reg(9 downto 1),
      ...
      mem_reg_0(8 downto 0) => Q(8 downto 0),
...
\half_axi_bits.ram_odd\: entity work.double_iq_pid_vco_dataReal_to_ram_fast_0_dataReal_to_ram_storage_0
     port map (
      D(9) => D(15),
      ...
      mem_reg_1(8 downto 0) => Q(8 downto 0),
...
architecture STRUCTURE of \double_iq_pid_vco_dataReal_to_ram_fast_0_dataReal_to_ram_subtop__xdcDup__1\ is
  ...
  signal \res_s[0]_0\ : STD_LOGIC_VECTOR ( 31 downto 1 );
  signal sample_cpt_s0 : STD_LOGIC;
...
\half_axi_bits.ram_even\: entity work.double_iq_pid_vco_dataReal_to_ram_fast_0_dataReal_to_ram_storage_1
     port map (
      D(7) => D(15),
      D(6) => D(13),
      D(5) => D(11),
      ...
      D(1) => D(2),
      D(0) => D(0),
      DOBDO(7) => \res_s[0]_0\(31),
      DOBDO(6) => \res_s[0]_0\(29),
      DOBDO(5) => \res_s[0]_0\(27),
      DOBDO(4) => \res_s[0]_0\(25),
      DOBDO(3) => \res_s[0]_0\(22),
      DOBDO(2) => \res_s[0]_0\(20),
      DOBDO(1) => \res_s[0]_0\(18),
      DOBDO(0) => \res_s[0]_0\(16),
      Q(9 downto 1) => sample_cpt_s_reg(9 downto 1),
      Q(0) => \sample_cpt_s_reg__0\(0),
      addr_s(1 downto 0) => addr_s(1 downto 0),
      busy_s => busy_s,
      ...
      mem_reg_0(7) => \res_s[0]_0\(14),
      mem_reg_0(6) => \res_s[0]_0\(12),
      mem_reg_0(5) => \res_s[0]_0\(10),
      mem_reg_0(4 downto 3) => \res_s[0]_0\(8 downto 7),
      mem_reg_0(2) => \res_s[0]_0\(5),
      mem_reg_0(1) => \res_s[0]_0\(3),
      mem_reg_0(0) => \res_s[0]_0\(1),
      mem_reg_1(8 downto 0) => Q(8 downto 0),
      \readdata_s_reg[0]\ => \readdata_s_reg[1]\,
      s00_axi_aclk => s00_axi_aclk,
      s00_axi_reset => s00_axi_reset
    );
\half_axi_bits.ram_odd\: entity work.double_iq_pid_vco_dataReal_to_ram_fast_0_dataReal_to_ram_storage_2
     port map (
      D(7) => D(14),
      D(6) => D(12),
      D(5) => D(10),
      ...
      data1_i(15 downto 0) => data1_i(15 downto 0),
      mem_reg_0(8 downto 0) => Q(8 downto 0),
      \readdata_s_reg[14]\(7) => \res_s[0]_0\(14),
      \readdata_s_reg[14]\(6) => \res_s[0]_0\(12),
      \readdata_s_reg[14]\(5) => \res_s[0]_0\(10),
      \readdata_s_reg[14]\(4 downto 3) => \res_s[0]_0\(8 downto 7),
      \readdata_s_reg[14]\(2) => \res_s[0]_0\(5),
      \readdata_s_reg[14]\(1) => \res_s[0]_0\(3),
      \readdata_s_reg[14]\(0) => \res_s[0]_0\(1),
...
architecture STRUCTURE of double_iq_pid_vco_dataReal_to_ram_fast_0_dataReal_to_ram_top is
  ...
  signal \ram_addr_s[8]_i_4_n_0\ : STD_LOGIC;
  signal ram_addr_s_reg : STD_LOGIC_VECTOR ( 8 downto 0 );
  ...
  attribute SOFT_HLUTNM of \ram_addr_s[3]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \ram_addr_s[4]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \ram_addr_s[7]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \ram_addr_s[8]_i_3\ : label is "soft_lutpair10";
begin
  busy_s <= \^busy_s\;
...
\ram_addr_s[8]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"DF20"
    )
        port map (
...
\ram_addr_s[8]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"7FFFFFFFFFFFFFFF"
    )
        port map (
...
\subtop_loop[0].data_subtop_inst\: entity work.\double_iq_pid_vco_dataReal_to_ram_fast_0_dataReal_to_ram_subtop__xdcDup__1\
     port map (
      ...
      Q(8 downto 0) => ram_addr_s_reg(8 downto 0),
      addr_s(1 downto 0) => addr_s(1 downto 0),
      busy_d_s => busy_d_s,
      busy_s => \^busy_s\,
      busy_s_2(0) => busy_s_2(0),
...
entity double_iq_pid_vco_dataReal_to_ram_fast_0_dataReal_to_ram is
  ...
  attribute DATA_SIZE of double_iq_pid_vco_dataReal_to_ram_fast_0_dataReal_to_ram : entity is 16;
...
architecture STRUCTURE of double_iq_pid_vco_dataReal_to_ram_fast_0 is
  ...
  attribute NB_SAMPLE : integer;
  attribute NB_SAMPLE of U0 : label is 1024;
  attribute USE_EOF : string;
...
begin
U0: entity work.double_iq_pid_vco_dataReal_to_ram_fast_0_dataReal_to_ram
     port map (
      data10_clk_i => '0',
      data10_en_i => '0',
      data10_eof_i => '0',
