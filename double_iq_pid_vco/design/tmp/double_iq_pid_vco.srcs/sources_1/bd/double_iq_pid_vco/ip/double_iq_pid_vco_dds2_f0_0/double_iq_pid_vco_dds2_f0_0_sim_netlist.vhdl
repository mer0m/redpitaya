...
-- Date        : Fri May 15 18:42:50 2020
-- Host        : ux305 running 64-bit Debian GNU/Linux 10 (buster)
-- Command     : write_vhdl -force -mode funcsim
--               /home/bma/git/github/oscimpDigital/app/redpitaya/double_iq_pid_vco/design/tmp/double_iq_pid_vco.srcs/sources_1/bd/double_iq_pid_vco/ip/double_iq_pid_vco_dds2_f0_0/double_iq_pid_vco_dds2_f0_0_sim_netlist.vhdl
-- Design      : double_iq_pid_vco_dds2_f0_0
...
entity double_iq_pid_vco_dds2_f0_0_add_constReal_handComm is
  port (
  ...
  attribute ORIG_REF_NAME of double_iq_pid_vco_dds2_f0_0_add_constReal_handComm : entity is "add_constReal_handComm";
end double_iq_pid_vco_dds2_f0_0_add_constReal_handComm;

architecture STRUCTURE of double_iq_pid_vco_dds2_f0_0_add_constReal_handComm is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity double_iq_pid_vco_dds2_f0_0_add_constReal_logic is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of double_iq_pid_vco_dds2_f0_0_add_constReal_logic : entity is "add_constReal_logic";
end double_iq_pid_vco_dds2_f0_0_add_constReal_logic;

architecture STRUCTURE of double_iq_pid_vco_dds2_f0_0_add_constReal_logic is
  signal data_in_s : STD_LOGIC_VECTOR ( 39 downto 0 );
  ...
  signal \data_s[35]_i_2_n_0\ : STD_LOGIC;
  signal \data_s[35]_i_3_n_0\ : STD_LOGIC;
  signal \data_s[35]_i_4_n_0\ : STD_LOGIC;
  signal \data_s[35]_i_5_n_0\ : STD_LOGIC;
  signal \data_s[39]_i_2_n_0\ : STD_LOGIC;
  signal \data_s[39]_i_3_n_0\ : STD_LOGIC;
  signal \data_s[39]_i_4_n_0\ : STD_LOGIC;
  ...
  signal \data_s_reg[31]_i_1_n_0\ : STD_LOGIC;
  signal \data_s_reg[31]_i_1_n_1\ : STD_LOGIC;
  signal \data_s_reg[31]_i_1_n_2\ : STD_LOGIC;
  signal \data_s_reg[31]_i_1_n_3\ : STD_LOGIC;
  signal \data_s_reg[35]_i_1_n_0\ : STD_LOGIC;
  signal \data_s_reg[35]_i_1_n_1\ : STD_LOGIC;
  signal \data_s_reg[35]_i_1_n_2\ : STD_LOGIC;
  signal \data_s_reg[35]_i_1_n_3\ : STD_LOGIC;
  signal \data_s_reg[39]_i_1_n_1\ : STD_LOGIC;
  signal \data_s_reg[39]_i_1_n_2\ : STD_LOGIC;
  signal \data_s_reg[39]_i_1_n_3\ : STD_LOGIC;
  ...
  signal \NLW_data_s_reg[39]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
begin
...
\data_s[35]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
      I0 => data_i(35),
      I1 => \out\(35),
      O => \data_s[35]_i_2_n_0\
    );
\data_s[35]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\data_s[35]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
      I0 => data_i(33),
      I1 => \out\(33),
      O => \data_s[35]_i_4_n_0\
    );
\data_s[35]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\data_s[39]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
      I0 => data_i(39),
      I1 => \out\(39),
      O => \data_s[39]_i_2_n_0\
    );
\data_s[39]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\data_s[39]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
      I0 => data_i(37),
      I1 => \out\(37),
      O => \data_s[39]_i_4_n_0\
    );
\data_s[39]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\data_s_reg[35]_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => \data_s_reg[31]_i_1_n_0\,
      CO(3) => \data_s_reg[35]_i_1_n_0\,
      CO(2) => \data_s_reg[35]_i_1_n_1\,
      CO(1) => \data_s_reg[35]_i_1_n_2\,
      CO(0) => \data_s_reg[35]_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => data_i(35 downto 32),
      O(3 downto 0) => data_in_s(35 downto 32),
      S(3) => \data_s[35]_i_2_n_0\,
      S(2) => \data_s[35]_i_3_n_0\,
      S(1) => \data_s[35]_i_4_n_0\,
      S(0) => \data_s[35]_i_5_n_0\
    );
...
\data_s_reg[39]_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => \data_s_reg[35]_i_1_n_0\,
      CO(3) => \NLW_data_s_reg[39]_i_1_CO_UNCONNECTED\(3),
      CO(2) => \data_s_reg[39]_i_1_n_1\,
      CO(1) => \data_s_reg[39]_i_1_n_2\,
      CO(0) => \data_s_reg[39]_i_1_n_3\,
      CYINIT => '0',
      DI(3) => '0',
      DI(2 downto 0) => data_i(38 downto 36),
      O(3 downto 0) => data_in_s(39 downto 36),
      S(3) => \data_s[39]_i_2_n_0\,
      S(2) => \data_s[39]_i_3_n_0\,
      S(1) => \data_s[39]_i_4_n_0\,
      S(0) => \data_s[39]_i_5_n_0\
    );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity double_iq_pid_vco_dds2_f0_0_add_constReal_synchronizer_vector is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of double_iq_pid_vco_dds2_f0_0_add_constReal_synchronizer_vector : entity is "add_constReal_synchronizer_vector";
end double_iq_pid_vco_dds2_f0_0_add_constReal_synchronizer_vector;

architecture STRUCTURE of double_iq_pid_vco_dds2_f0_0_add_constReal_synchronizer_vector is
  signal \flipflops[0]_0\ : STD_LOGIC_VECTOR ( 39 downto 0 );
  attribute async_reg : string;
  attribute async_reg of \flipflops[0]_0\ : signal is "true";
  signal \flipflops[1]_1\ : STD_LOGIC_VECTOR ( 39 downto 0 );
  attribute async_reg of \flipflops[1]_1\ : signal is "true";
  signal \flipflops[2]_2\ : STD_LOGIC_VECTOR ( 39 downto 0 );
  ...
  attribute ASYNC_REG_boolean of \flipflops_reg[0][14]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[0][14]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[0][15]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[0][15]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[0][16]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[0][16]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[0][17]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[0][17]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[0][18]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[0][18]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[0][19]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[0][19]\ : label is "yes";
  ...
  attribute ASYNC_REG_boolean of \flipflops_reg[0][20]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[0][20]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[0][21]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[0][21]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[0][22]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[0][22]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[0][23]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[0][23]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[0][24]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[0][24]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[0][25]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[0][25]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[0][26]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[0][26]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[0][27]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[0][27]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[0][28]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[0][28]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[0][29]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[0][29]\ : label is "yes";
  ...
  attribute ASYNC_REG_boolean of \flipflops_reg[0][30]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[0][30]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[0][31]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[0][31]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[0][32]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[0][32]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[0][33]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[0][33]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[0][34]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[0][34]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[0][35]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[0][35]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[0][36]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[0][36]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[0][37]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[0][37]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[0][38]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[0][38]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[0][39]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[0][39]\ : label is "yes";
  ...
  attribute ASYNC_REG_boolean of \flipflops_reg[1][14]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[1][14]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[1][15]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[1][15]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[1][16]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[1][16]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[1][17]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[1][17]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[1][18]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[1][18]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[1][19]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[1][19]\ : label is "yes";
  ...
  attribute ASYNC_REG_boolean of \flipflops_reg[1][20]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[1][20]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[1][21]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[1][21]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[1][22]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[1][22]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[1][23]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[1][23]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[1][24]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[1][24]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[1][25]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[1][25]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[1][26]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[1][26]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[1][27]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[1][27]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[1][28]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[1][28]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[1][29]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[1][29]\ : label is "yes";
  ...
  attribute ASYNC_REG_boolean of \flipflops_reg[1][30]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[1][30]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[1][31]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[1][31]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[1][32]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[1][32]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[1][33]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[1][33]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[1][34]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[1][34]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[1][35]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[1][35]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[1][36]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[1][36]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[1][37]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[1][37]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[1][38]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[1][38]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[1][39]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[1][39]\ : label is "yes";
  ...
  attribute ASYNC_REG_boolean of \flipflops_reg[2][14]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[2][14]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[2][15]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[2][15]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[2][16]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[2][16]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[2][17]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[2][17]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[2][18]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[2][18]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[2][19]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[2][19]\ : label is "yes";
  ...
  attribute ASYNC_REG_boolean of \flipflops_reg[2][20]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[2][20]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[2][21]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[2][21]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[2][22]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[2][22]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[2][23]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[2][23]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[2][24]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[2][24]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[2][25]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[2][25]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[2][26]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[2][26]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[2][27]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[2][27]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[2][28]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[2][28]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[2][29]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[2][29]\ : label is "yes";
  ...
  attribute ASYNC_REG_boolean of \flipflops_reg[2][30]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[2][30]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[2][31]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[2][31]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[2][32]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[2][32]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[2][33]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[2][33]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[2][34]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[2][34]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[2][35]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[2][35]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[2][36]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[2][36]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[2][37]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[2][37]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[2][38]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[2][38]\ : label is "yes";
  attribute ASYNC_REG_boolean of \flipflops_reg[2][39]\ : label is std.standard.true;
  attribute KEEP of \flipflops_reg[2][39]\ : label is "yes";
...
begin
  \out\(39 downto 0) <= \flipflops[2]_2\(39 downto 0);
...
\flipflops_reg[0][14]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[0][15]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[0][16]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[0][17]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[0][18]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[0][19]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[0][20]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[0][21]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[0][22]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[0][23]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[0][24]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[0][25]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[0][26]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[0][27]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[0][28]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[0][29]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[0][30]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[0][31]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[0][32]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[0][33]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[0][34]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[0][35]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[0][36]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[0][37]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[0][38]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[0][39]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[1][14]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[1][15]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[1][16]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[1][17]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[1][18]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[1][19]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[1][20]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[1][21]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[1][22]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[1][23]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[1][24]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[1][25]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[1][26]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[1][27]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[1][28]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[1][29]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[1][30]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[1][31]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[1][32]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[1][33]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[1][34]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[1][35]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[1][36]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[1][37]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[1][38]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[1][39]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[2][14]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[2][15]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[2][16]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[2][17]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[2][18]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[2][19]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[2][20]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[2][21]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[2][22]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[2][23]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[2][24]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[2][25]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[2][26]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[2][27]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[2][28]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[2][29]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[2][30]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[2][31]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[2][32]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[2][33]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[2][34]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[2][35]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[2][36]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[2][37]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[2][38]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\flipflops_reg[2][39]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity double_iq_pid_vco_dds2_f0_0_wb_add_constReal is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of double_iq_pid_vco_dds2_f0_0_wb_add_constReal : entity is "wb_add_constReal";
end double_iq_pid_vco_dds2_f0_0_wb_add_constReal;

architecture STRUCTURE of double_iq_pid_vco_dds2_f0_0_wb_add_constReal is
  signal \^q\ : STD_LOGIC_VECTOR ( 39 downto 0 );
  signal offset_l_s : STD_LOGIC_VECTOR ( 31 downto 0 );
  signal offset_s : STD_LOGIC_VECTOR ( 63 downto 40 );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity double_iq_pid_vco_dds2_f0_0_add_constReal is
  port (
    s00_axi_aclk : in STD_LOGIC;
    s00_axi_reset : in STD_LOGIC;
  ...
  attribute C_S00_AXI_ADDR_WIDTH of double_iq_pid_vco_dds2_f0_0_add_constReal : entity is 4;
  attribute C_S00_AXI_DATA_WIDTH : integer;
  attribute C_S00_AXI_DATA_WIDTH of double_iq_pid_vco_dds2_f0_0_add_constReal : entity is 32;
  attribute DATA_IN_SIZE : integer;
  attribute DATA_IN_SIZE of double_iq_pid_vco_dds2_f0_0_add_constReal : entity is 40;
  attribute DATA_OUT_SIZE : integer;
  attribute DATA_OUT_SIZE of double_iq_pid_vco_dds2_f0_0_add_constReal : entity is 40;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of double_iq_pid_vco_dds2_f0_0_add_constReal : entity is "add_constReal";
  attribute add_val : integer;
  attribute add_val of double_iq_pid_vco_dds2_f0_0_add_constReal : entity is 0;
  attribute format : string;
  attribute format of double_iq_pid_vco_dds2_f0_0_add_constReal : entity is "unsigned";
  attribute id : integer;
  attribute id of double_iq_pid_vco_dds2_f0_0_add_constReal : entity is 1;
end double_iq_pid_vco_dds2_f0_0_add_constReal;

architecture STRUCTURE of double_iq_pid_vco_dds2_f0_0_add_constReal is
  signal \<const0>\ : STD_LOGIC;
  signal addr_s : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \^data_clk_i\ : STD_LOGIC;
  signal \^data_rst_i\ : STD_LOGIC;
  signal offset_l_s : STD_LOGIC;
  signal offset_s : STD_LOGIC_VECTOR ( 39 downto 0 );
  signal offset_s_0 : STD_LOGIC;
  signal offset_sync_s : STD_LOGIC_VECTOR ( 39 downto 0 );
...
add_constRealHandComm: entity work.double_iq_pid_vco_dds2_f0_0_add_constReal_handComm
     port map (
      E(0) => offset_s_0,
      addr_s(1 downto 0) => addr_s(1 downto 0),
...
add_constRealLogic: entity work.double_iq_pid_vco_dds2_f0_0_add_constReal_logic
     port map (
      data_clk_i => \^data_clk_i\,
      data_en_i => data_en_i,
      data_en_o => data_en_o,
      data_i(39 downto 0) => data_i(39 downto 0),
      data_o(39 downto 0) => data_o(39 downto 0),
      data_rst_i => \^data_rst_i\,
      \out\(39 downto 0) => offset_sync_s(39 downto 0)
    );
offset_syn: entity work.double_iq_pid_vco_dds2_f0_0_add_constReal_synchronizer_vector
     port map (
      Q(39 downto 0) => offset_s(39 downto 0),
      data_clk_i => \^data_clk_i\,
      \out\(39 downto 0) => offset_sync_s(39 downto 0)
    );
wb_add_constReal_inst: entity work.double_iq_pid_vco_dds2_f0_0_wb_add_constReal
     port map (
      E(0) => offset_l_s,
      Q(39 downto 0) => offset_s(39 downto 0),
      addr_s(1 downto 0) => addr_s(1 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity double_iq_pid_vco_dds2_f0_0 is
  port (
    s00_axi_aclk : in STD_LOGIC;
    s00_axi_reset : in STD_LOGIC;
    s00_axi_awaddr : in STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute NotValidForBitStream of double_iq_pid_vco_dds2_f0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of double_iq_pid_vco_dds2_f0_0 : entity is "double_iq_pid_vco_dds2_f0_0,add_constReal,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of double_iq_pid_vco_dds2_f0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of double_iq_pid_vco_dds2_f0_0 : entity is "add_constReal,Vivado 2019.2";
end double_iq_pid_vco_dds2_f0_0;

architecture STRUCTURE of double_iq_pid_vco_dds2_f0_0 is
  attribute C_S00_AXI_ADDR_WIDTH : integer;
  attribute C_S00_AXI_ADDR_WIDTH of U0 : label is 4;
  attribute C_S00_AXI_DATA_WIDTH : integer;
  attribute C_S00_AXI_DATA_WIDTH of U0 : label is 32;
  attribute DATA_IN_SIZE : integer;
  attribute DATA_IN_SIZE of U0 : label is 40;
  attribute DATA_OUT_SIZE : integer;
  attribute DATA_OUT_SIZE of U0 : label is 40;
  attribute add_val : integer;
...
begin
U0: entity work.double_iq_pid_vco_dds2_f0_0_add_constReal
     port map (
      data_clk_i => data_clk_i,
