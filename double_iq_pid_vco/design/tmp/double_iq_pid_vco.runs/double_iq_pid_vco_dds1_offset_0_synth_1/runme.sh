...
EAStep vivado -log double_iq_pid_vco_dds1_offset_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source double_iq_pid_vco_dds1_offset_0.tcl
