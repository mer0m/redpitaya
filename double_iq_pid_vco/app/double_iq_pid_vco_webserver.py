...
class MyApp(App):
	...
	def sd_sp_pidv3_axi_0_changed(self, widget, value):
		...
		liboscimp_fpga.pidv3_axi_set("/dev/pidv3_axi_0", liboscimp_fpga.SETPOINT, int(value))
	...
	def sd_sp_pidv3_axi_1_changed(self, widget, value):
		...
		liboscimp_fpga.pidv3_axi_set("/dev/pidv3_axi_1", liboscimp_fpga.SETPOINT, int(value))
