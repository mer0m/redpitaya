...
class MyApp(App):
	...
	def main(self):
		...
		self.sd_dds1_f0.set_on_change_listener(self.sd_dds1_f0_changed)
		...
		self.sd_pinc_dds1_nco.set_on_change_listener(self.sd_pinc_dds1_nco_changed)
		...
		self.sd_poff_dds1_nco.set_on_change_listener(self.sd_poff_dds1_nco_changed)
		...
		self.sd_dds2_f0.set_on_change_listener(self.sd_dds2_f0_changed)
		...
		self.sd_pinc_dds2_nco.set_on_change_listener(self.sd_pinc_dds2_nco_changed)
		...
		self.sd_poff_dds2_nco.set_on_change_listener(self.sd_poff_dds2_nco_changed)
		...
		self.sd_ch1_dds_range.set_on_change_listener(self.sd_ch1_dds_range_changed)
		...
		self.sd_ch2_dds_range.set_on_change_listener(self.sd_ch2_dds_range_changed)
		...
		self.sd_pinc_demod1_nco.set_on_change_listener(self.sd_pinc_demod1_nco_changed)
		...
		self.sd_poff_demod1_nco.set_on_change_listener(self.sd_poff_demod1_nco_changed)
		...
		self.sd_pinc_demod2_nco.set_on_change_listener(self.sd_pinc_demod2_nco_changed)
		...
		self.sd_poff_demod2_nco.set_on_change_listener(self.sd_poff_demod2_nco_changed)
		...
		self.sd_shifterReal_dyn_1.set_on_change_listener(self.sd_shifterReal_dyn_1_changed)
		self.sb_shifterReal_dyn_1 = gui.SpinBox(vals.shifterReal_dyn_1, -8192, 8191, 1, width="20%", margin="10px")
		self.sb_shifterReal_dyn_1.set_on_change_listener(self.sb_shifterReal_dyn_1_changed)
	...
	def sd_pinc_dds1_nco_changed(self, widget, value):
		...
		print("/dev/dds1_nco", samp_freq, float(value), 40, int(self.sb_poff_dds1_nco.get_value()), int(self.cb_pinc_dds1_nco.get_value()), int(self.cb_poff_dds1_nco.get_value()))
		...
		self.sb_pinc_dds1_nco.set_value(float(value))
	...
	def sd_pinc_dds2_nco_changed(self, widget, value):
		...
		print("/dev/dds2_nco", samp_freq, float(value), 40, int(self.sb_poff_dds2_nco.get_value()), int(self.cb_pinc_dds2_nco.get_value()), int(self.cb_poff_dds2_nco.get_value()))
		...
		self.sb_pinc_dds2_nco.set_value(float(value))
	...
	def sd_pinc_demod1_nco_changed(self, widget, value):
		...
		print("/dev/demod1_nco", samp_freq, float(value), 40, int(self.sb_poff_demod1_nco.get_value()), int(self.cb_pinc_demod1_nco.get_value()), int(self.cb_poff_demod1_nco.get_value()))
		...
		self.sb_pinc_demod1_nco.set_value(float(value))
	...
	def sd_pinc_demod2_nco_changed(self, widget, value):
		...
		print("/dev/demod2_nco", samp_freq, float(value), 40, int(self.sb_poff_demod2_nco.get_value()), int(self.cb_pinc_demod2_nco.get_value()), int(self.cb_poff_demod2_nco.get_value()))
		...
		self.sb_pinc_demod2_nco.set_value(float(value))
