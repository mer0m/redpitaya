...
-- Date        : Wed May  9 11:11:47 2018
-- Host        : ux305 running 64-bit Debian GNU/Linux testing/unstable
-- Command     : write_vhdl -force -mode funcsim
--               /home/bma/git/fpga_design/redpitaya/pid_vco_amp_mod_pid_only/pid_vco_amp_mod_pid_only.srcs/sources_1/bd/pid_vco_amp_mod_pid_only_wrapper/ip/pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0/pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0_sim_netlist.vhdl
-- Design      : pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0
...
entity pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0_redpitaya_adc_dac_clk is
  port (
  ...
  attribute ORIG_REF_NAME of pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0_redpitaya_adc_dac_clk : entity is "redpitaya_adc_dac_clk";
end pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0_redpitaya_adc_dac_clk;

architecture STRUCTURE of pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0_redpitaya_adc_dac_clk is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0 is
  port (
    adc_clk_p_i : in STD_LOGIC;
    adc_clk_n_i : in STD_LOGIC;
    dac_clk_o : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0 : entity is "pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0,redpitaya_adc_dac_clk,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0 : entity is "redpitaya_adc_dac_clk,Vivado 2016.4";
end pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0;

architecture STRUCTURE of pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0 is
begin
inst: entity work.pid_vco_amp_mod_pid_only_wrapper_redpitaya_adc_dac_clk_0_0_redpitaya_adc_dac_clk
     port map (
