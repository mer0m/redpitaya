...
HD_PWD='/home/bma/git/fpga_design/redpitaya/adc2dac_ram_offset/adc2dac_ram_offset.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adc2dac_ram_offset_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adc2dac_ram_offset_wrapper.tcl -notrace
