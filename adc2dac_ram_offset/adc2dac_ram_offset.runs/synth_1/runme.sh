...
HD_PWD='/home/bma/git/fpga_design/redpitaya/adc2dac_ram_offset/adc2dac_ram_offset.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adc2dac_ram_offset_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adc2dac_ram_offset_wrapper.tcl
