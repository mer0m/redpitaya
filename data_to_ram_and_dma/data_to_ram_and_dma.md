# data_to_ram_and_dma.tcl
```mermaid
graph LR
adc1_duppl --> |data1_out >> data1_in| data2ram
adc1_offset --> |data_out >> data_in| adc1_duppl
adc2_duppl --> |data1_out >> data2_in| data2ram
adc2_offset --> |data_out >> data_in| adc2_duppl
