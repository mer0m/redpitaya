...
HD_PWD='/home/bma/git/fpga_design/redpitaya/vco_only/vco_only.runs/vco_only_wrapper_twoInMult_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vco_only_wrapper_twoInMult_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vco_only_wrapper_twoInMult_0_0.tcl
