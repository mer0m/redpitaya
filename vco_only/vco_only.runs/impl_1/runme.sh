...
HD_PWD='/home/bma/git/fpga_design/redpitaya/vco_only/vco_only.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vco_only_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vco_only_wrapper.tcl -notrace
