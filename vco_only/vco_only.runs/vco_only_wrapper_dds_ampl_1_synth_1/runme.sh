...
HD_PWD='/home/bma/git/fpga_design/redpitaya/vco_only/vco_only.runs/vco_only_wrapper_dds_ampl_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vco_only_wrapper_dds_ampl_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vco_only_wrapper_dds_ampl_1.tcl
