...
-- Date        : Fri Mar 31 16:15:12 2017
-- Host        : ux305 running 64-bit Debian GNU/Linux 9.0 (stretch)
-- Command     : write_vhdl -force -mode funcsim
--               /home/bma/git/fpga_design/redpitaya/vco_only/vco_only.srcs/sources_1/bd/vco_only_wrapper/ip/vco_only_wrapper_twoInMult_0_0/vco_only_wrapper_twoInMult_0_0_sim_netlist.vhdl
-- Design      : vco_only_wrapper_twoInMult_0_0
...
entity vco_only_wrapper_twoInMult_0_0_twoInMult is
  port (
  ...
  attribute ORIG_REF_NAME of vco_only_wrapper_twoInMult_0_0_twoInMult : entity is "twoInMult";
end vco_only_wrapper_twoInMult_0_0_twoInMult;

architecture STRUCTURE of vco_only_wrapper_twoInMult_0_0_twoInMult is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity vco_only_wrapper_twoInMult_0_0 is
  port (
    data1_i : in STD_LOGIC_VECTOR ( 13 downto 0 );
    data1_en_i : in STD_LOGIC;
    data1_clk_i : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of vco_only_wrapper_twoInMult_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of vco_only_wrapper_twoInMult_0_0 : entity is "vco_only_wrapper_twoInMult_0_0,twoInMult,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of vco_only_wrapper_twoInMult_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of vco_only_wrapper_twoInMult_0_0 : entity is "twoInMult,Vivado 2016.4";
end vco_only_wrapper_twoInMult_0_0;

architecture STRUCTURE of vco_only_wrapper_twoInMult_0_0 is
  signal \^data1_clk_i\ : STD_LOGIC;
begin
  \^data1_clk_i\ <= data1_clk_i;
  data_clk_o <= \^data1_clk_i\;
U0: entity work.vco_only_wrapper_twoInMult_0_0_twoInMult
     port map (
      data1_clk_i => \^data1_clk_i\,
