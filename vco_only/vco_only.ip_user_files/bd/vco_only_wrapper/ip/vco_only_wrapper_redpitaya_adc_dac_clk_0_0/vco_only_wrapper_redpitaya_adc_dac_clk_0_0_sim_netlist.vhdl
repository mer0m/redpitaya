...
-- Date        : Fri Mar 31 16:12:49 2017
-- Host        : ux305 running 64-bit Debian GNU/Linux 9.0 (stretch)
-- Command     : write_vhdl -force -mode funcsim
--               /home/bma/git/fpga_design/redpitaya/vco_only/vco_only.srcs/sources_1/bd/vco_only_wrapper/ip/vco_only_wrapper_redpitaya_adc_dac_clk_0_0/vco_only_wrapper_redpitaya_adc_dac_clk_0_0_sim_netlist.vhdl
-- Design      : vco_only_wrapper_redpitaya_adc_dac_clk_0_0
...
entity vco_only_wrapper_redpitaya_adc_dac_clk_0_0_redpitaya_adc_dac_clk is
  port (
  ...
  attribute ORIG_REF_NAME of vco_only_wrapper_redpitaya_adc_dac_clk_0_0_redpitaya_adc_dac_clk : entity is "redpitaya_adc_dac_clk";
end vco_only_wrapper_redpitaya_adc_dac_clk_0_0_redpitaya_adc_dac_clk;

architecture STRUCTURE of vco_only_wrapper_redpitaya_adc_dac_clk_0_0_redpitaya_adc_dac_clk is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity vco_only_wrapper_redpitaya_adc_dac_clk_0_0 is
  port (
    adc_clk_p_i : in STD_LOGIC;
    adc_clk_n_i : in STD_LOGIC;
    dac_clk_o : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of vco_only_wrapper_redpitaya_adc_dac_clk_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of vco_only_wrapper_redpitaya_adc_dac_clk_0_0 : entity is "vco_only_wrapper_redpitaya_adc_dac_clk_0_0,redpitaya_adc_dac_clk,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of vco_only_wrapper_redpitaya_adc_dac_clk_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of vco_only_wrapper_redpitaya_adc_dac_clk_0_0 : entity is "redpitaya_adc_dac_clk,Vivado 2016.4";
end vco_only_wrapper_redpitaya_adc_dac_clk_0_0;

architecture STRUCTURE of vco_only_wrapper_redpitaya_adc_dac_clk_0_0 is
begin
inst: entity work.vco_only_wrapper_redpitaya_adc_dac_clk_0_0_redpitaya_adc_dac_clk
     port map (
