...
HD_PWD='/home/bma/git/fpga_design/redpitaya/double_dds/double_dds.runs/double_dds_wrapper_dds1_nco_counter_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log double_dds_wrapper_dds1_nco_counter_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source double_dds_wrapper_dds1_nco_counter_1.tcl
