...
ISEStep( "vivado",
         "-log double_dds_wrapper_dds1_nco_counter_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source double_dds_wrapper_dds1_nco_counter_0.tcl" );
