...
HD_PWD='/home/bma/git/fpga_design/redpitaya/double_dds/double_dds.runs/double_dds_wrapper_redpitaya_adc_dac_clk_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log double_dds_wrapper_redpitaya_adc_dac_clk_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source double_dds_wrapper_redpitaya_adc_dac_clk_0_0.tcl
