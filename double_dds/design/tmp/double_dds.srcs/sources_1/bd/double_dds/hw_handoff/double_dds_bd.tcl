...
################################################################
# This is a generated script based on design: double_dds
#
...
proc create_root_design { parentCell } {
  ...
  set conv_nco_counter_1 [ create_bd_cell -type ip -vlnv ggm:cogen:convertComplexToReal:1.0 conv_nco_counter_1 ]
  set_property -dict [ list \
   CONFIG.DATA_SIZE {16} \
 ] $conv_nco_counter_1

  # Create instance: conv_nco_counter_2, and set properties
  set conv_nco_counter_2 [ create_bd_cell -type ip -vlnv ggm:cogen:convertComplexToReal:1.0 conv_nco_counter_2 ]
  set_property -dict [ list \
   CONFIG.DATA_SIZE {16} \
 ] $conv_nco_counter_2
  ...
  set nco_counter_2 [ create_bd_cell -type ip -vlnv ggm:cogen:nco_counter:1.0 nco_counter_2 ]
  set_property -dict [ list \
   CONFIG.COUNTER_SIZE {40} \
   CONFIG.LUT_SIZE {12} \
 ] $nco_counter_2
  ...
  connect_bd_intf_net -intf_net ps7_axi_M00_AXI [get_bd_intf_pins dds_ampl/s00_axi] [get_bd_intf_pins ps7_axi/M00_AXI]
  connect_bd_intf_net -intf_net ps7_axi_M01_AXI [get_bd_intf_pins nco_counter_1/s00_axi] [get_bd_intf_pins ps7_axi/M01_AXI]
