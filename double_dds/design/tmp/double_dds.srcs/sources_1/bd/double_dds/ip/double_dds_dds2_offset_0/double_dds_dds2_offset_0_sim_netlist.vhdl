...
-- Command     : write_vhdl -force -mode funcsim -rename_top double_dds_dds2_offset_0 -prefix
--               double_dds_dds2_offset_0_ double_dds_dds1_offset_0_sim_netlist.vhdl
...
entity double_dds_dds2_offset_0_add_constReal_handComm is
  port (
...
end double_dds_dds2_offset_0_add_constReal_handComm;

architecture STRUCTURE of double_dds_dds2_offset_0_add_constReal_handComm is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity double_dds_dds2_offset_0_add_constReal_logic is
  port (
...
end double_dds_dds2_offset_0_add_constReal_logic;

architecture STRUCTURE of double_dds_dds2_offset_0_add_constReal_logic is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity double_dds_dds2_offset_0_add_constReal_synchronizer_vector is
  port (
    \out\ : out STD_LOGIC_VECTOR ( 13 downto 0 );
    Q : in STD_LOGIC_VECTOR ( 13 downto 0 );
    data_clk_i : in STD_LOGIC
  );
end double_dds_dds2_offset_0_add_constReal_synchronizer_vector;

architecture STRUCTURE of double_dds_dds2_offset_0_add_constReal_synchronizer_vector is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity double_dds_dds2_offset_0_wb_add_constReal is
  port (
...
end double_dds_dds2_offset_0_wb_add_constReal;

architecture STRUCTURE of double_dds_dds2_offset_0_wb_add_constReal is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity double_dds_dds2_offset_0_add_constReal is
  port (
    s00_axi_aclk : in STD_LOGIC;
    s00_axi_reset : in STD_LOGIC;
  ...
  attribute C_S00_AXI_ADDR_WIDTH of double_dds_dds2_offset_0_add_constReal : entity is 4;
  attribute C_S00_AXI_DATA_WIDTH : integer;
  attribute C_S00_AXI_DATA_WIDTH of double_dds_dds2_offset_0_add_constReal : entity is 32;
  attribute DATA_IN_SIZE : integer;
  attribute DATA_IN_SIZE of double_dds_dds2_offset_0_add_constReal : entity is 14;
  attribute DATA_OUT_SIZE : integer;
  attribute DATA_OUT_SIZE of double_dds_dds2_offset_0_add_constReal : entity is 14;
  attribute add_val : integer;
  attribute add_val of double_dds_dds2_offset_0_add_constReal : entity is 0;
  attribute format : string;
  attribute format of double_dds_dds2_offset_0_add_constReal : entity is "signed";
  attribute id : integer;
  attribute id of double_dds_dds2_offset_0_add_constReal : entity is 1;
end double_dds_dds2_offset_0_add_constReal;

architecture STRUCTURE of double_dds_dds2_offset_0_add_constReal is
...
add_constRealHandComm: entity work.double_dds_dds2_offset_0_add_constReal_handComm
     port map (
      E(0) => offset_s_0,
      addr_s(1 downto 0) => addr_s(1 downto 0),
...
add_constRealLogic: entity work.double_dds_dds2_offset_0_add_constReal_logic
     port map (
      data_clk_i => \^data_clk_i\,
      data_en_i => data_en_i,
      data_en_o => data_en_o,
...
offset_syn: entity work.double_dds_dds2_offset_0_add_constReal_synchronizer_vector
     port map (
      Q(13 downto 0) => offset_s(13 downto 0),
      data_clk_i => \^data_clk_i\,
      \out\(13 downto 0) => offset_sync_s(13 downto 0)
    );
wb_add_constReal_inst: entity work.double_dds_dds2_offset_0_wb_add_constReal
     port map (
      E(0) => offset_l_s,
      Q(13 downto 0) => offset_s(13 downto 0),
      addr_s(1 downto 0) => addr_s(1 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity double_dds_dds2_offset_0 is
  port (
    s00_axi_aclk : in STD_LOGIC;
    s00_axi_reset : in STD_LOGIC;
    s00_axi_awaddr : in STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute NotValidForBitStream of double_dds_dds2_offset_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of double_dds_dds2_offset_0 : entity is "double_dds_dds1_offset_0,add_constReal,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of double_dds_dds2_offset_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of double_dds_dds2_offset_0 : entity is "add_constReal,Vivado 2019.2";
end double_dds_dds2_offset_0;

architecture STRUCTURE of double_dds_dds2_offset_0 is
  attribute C_S00_AXI_ADDR_WIDTH : integer;
...
begin
U0: entity work.double_dds_dds2_offset_0_add_constReal
     port map (
      data_clk_i => data_clk_i,
