...
-- Command     : write_vhdl -force -mode funcsim -rename_top double_dds_nco_counter_4_0 -prefix
--               double_dds_nco_counter_4_0_ double_dds_nco_counter_3_0_sim_netlist.vhdl
...
entity double_dds_nco_counter_4_0_nco_counter_cos_rom_a12_d16 is
  port (
...
end double_dds_nco_counter_4_0_nco_counter_cos_rom_a12_d16;

architecture STRUCTURE of double_dds_nco_counter_4_0_nco_counter_cos_rom_a12_d16 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity double_dds_nco_counter_4_0_nco_counter_handcomm is
  port (
...
end double_dds_nco_counter_4_0_nco_counter_handcomm;

architecture STRUCTURE of double_dds_nco_counter_4_0_nco_counter_handcomm is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity double_dds_nco_counter_4_0_nco_counter_synchronizer_bit is
  port (
...
end double_dds_nco_counter_4_0_nco_counter_synchronizer_bit;

architecture STRUCTURE of double_dds_nco_counter_4_0_nco_counter_synchronizer_bit is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \double_dds_nco_counter_4_0_nco_counter_synchronizer_bit__xdcDup__1\ is
  port (
  ...
  attribute ORIG_REF_NAME of \double_dds_nco_counter_4_0_nco_counter_synchronizer_bit__xdcDup__1\ : entity is "nco_counter_synchronizer_bit";
end \double_dds_nco_counter_4_0_nco_counter_synchronizer_bit__xdcDup__1\;

architecture STRUCTURE of \double_dds_nco_counter_4_0_nco_counter_synchronizer_bit__xdcDup__1\ is
  signal flipflops : STD_LOGIC_VECTOR ( 2 downto 0 );
  attribute async_reg : string;
  attribute async_reg of flipflops : signal is "true";
  signal sync_stage0_s_reg_n_0 : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \double_dds_nco_counter_4_0_nco_counter_synchronizer_bit__xdcDup__2\ is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \double_dds_nco_counter_4_0_nco_counter_synchronizer_bit__xdcDup__2\ : entity is "nco_counter_synchronizer_bit";
end \double_dds_nco_counter_4_0_nco_counter_synchronizer_bit__xdcDup__2\;

architecture STRUCTURE of \double_dds_nco_counter_4_0_nco_counter_synchronizer_bit__xdcDup__2\ is
  signal flipflops : STD_LOGIC_VECTOR ( 2 downto 0 );
  attribute async_reg : string;
  attribute async_reg of flipflops : signal is "true";
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity double_dds_nco_counter_4_0_nco_counter_synchronizer_vector is
  port (
    Q : in STD_LOGIC_VECTOR ( 39 downto 0 );
    s00_axi_aclk : in STD_LOGIC;
    ref_clk_i : in STD_LOGIC
  );
end double_dds_nco_counter_4_0_nco_counter_synchronizer_vector;

architecture STRUCTURE of double_dds_nco_counter_4_0_nco_counter_synchronizer_vector is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \double_dds_nco_counter_4_0_nco_counter_synchronizer_vector__parameterized0\ is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \double_dds_nco_counter_4_0_nco_counter_synchronizer_vector__parameterized0\ : entity is "nco_counter_synchronizer_vector";
end \double_dds_nco_counter_4_0_nco_counter_synchronizer_vector__parameterized0\;

architecture STRUCTURE of \double_dds_nco_counter_4_0_nco_counter_synchronizer_vector__parameterized0\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \double_dds_nco_counter_4_0_nco_counter_synchronizer_vector__xdcDup__1\ is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \double_dds_nco_counter_4_0_nco_counter_synchronizer_vector__xdcDup__1\ : entity is "nco_counter_synchronizer_vector";
end \double_dds_nco_counter_4_0_nco_counter_synchronizer_vector__xdcDup__1\;

architecture STRUCTURE of \double_dds_nco_counter_4_0_nco_counter_synchronizer_vector__xdcDup__1\ is
  signal \flipflops_vect[0]_0\ : STD_LOGIC_VECTOR ( 39 downto 0 );
  attribute async_reg : string;
  attribute async_reg of \flipflops_vect[0]_0\ : signal is "true";
  signal \flipflops_vect[1]_1\ : STD_LOGIC_VECTOR ( 39 downto 0 );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity double_dds_nco_counter_4_0_wb_nco_counter is
  port (
...
end double_dds_nco_counter_4_0_wb_nco_counter;

architecture STRUCTURE of double_dds_nco_counter_4_0_wb_nco_counter is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity double_dds_nco_counter_4_0_nco_counter_logic is
  port (
...
end double_dds_nco_counter_4_0_nco_counter_logic;

architecture STRUCTURE of double_dds_nco_counter_4_0_nco_counter_logic is
...
\rom_12.rom12_inst\: entity work.double_dds_nco_counter_4_0_nco_counter_cos_rom_a12_d16
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity double_dds_nco_counter_4_0_nco_counter is
  port (
    ref_clk_i : in STD_LOGIC;
    ref_rst_i : in STD_LOGIC;
    s00_axi_aclk : in STD_LOGIC;
  ...
  attribute COUNTER_SIZE of double_dds_nco_counter_4_0_nco_counter : entity is 40;
  attribute C_S00_AXI_ADDR_WIDTH : integer;
  attribute C_S00_AXI_ADDR_WIDTH of double_dds_nco_counter_4_0_nco_counter : entity is 5;
  attribute C_S00_AXI_DATA_WIDTH : integer;
  attribute C_S00_AXI_DATA_WIDTH of double_dds_nco_counter_4_0_nco_counter : entity is 32;
  attribute DATA_SIZE : integer;
  attribute DATA_SIZE of double_dds_nco_counter_4_0_nco_counter : entity is 16;
  attribute DEFAULT_RST_ACCUM_VAL : integer;
  attribute DEFAULT_RST_ACCUM_VAL of double_dds_nco_counter_4_0_nco_counter : entity is 25;
  attribute LUT_SIZE : integer;
  attribute LUT_SIZE of double_dds_nco_counter_4_0_nco_counter : entity is 12;
  attribute RESET_ACCUM : string;
  attribute RESET_ACCUM of double_dds_nco_counter_4_0_nco_counter : entity is "FALSE";
  attribute id : integer;
  attribute id of double_dds_nco_counter_4_0_nco_counter : entity is 1;
end double_dds_nco_counter_4_0_nco_counter;

architecture STRUCTURE of double_dds_nco_counter_4_0_nco_counter is
...
cpt_off_syn: entity work.\double_dds_nco_counter_4_0_nco_counter_synchronizer_vector__parameterized0\
     port map (
...
cpt_step_syn: entity work.\double_dds_nco_counter_4_0_nco_counter_synchronizer_vector__xdcDup__1\
     port map (
...
enable_syn: entity work.\double_dds_nco_counter_4_0_nco_counter_synchronizer_bit__xdcDup__1\
     port map (
      enable_s => enable_s,
      int_rst_s => int_rst_s,
      ref_clk_i => \^ref_clk_i\,
...
handle_comm: entity work.double_dds_nco_counter_4_0_nco_counter_handcomm
     port map (
...
max_acc_syn: entity work.double_dds_nco_counter_4_0_nco_counter_synchronizer_vector
     port map (
      Q(39 downto 0) => max_accum_s(39 downto 0),
      ref_clk_i => \^ref_clk_i\,
      s00_axi_aclk => s00_axi_aclk
    );
nco_inst1: entity work.double_dds_nco_counter_4_0_nco_counter_logic
     port map (
      DI(3) => nco_inst1_n_2,
      DI(2) => nco_inst1_n_3,
      DI(1) => nco_inst1_n_4,
...
pinc_syn: entity work.\double_dds_nco_counter_4_0_nco_counter_synchronizer_bit__xdcDup__2\
     port map (
      DI(3) => nco_inst1_n_2,
      DI(2) => nco_inst1_n_3,
      DI(1) => nco_inst1_n_4,
...
poff_syn: entity work.double_dds_nco_counter_4_0_nco_counter_synchronizer_bit
     port map (
      data3(0) => data3(1),
      \out\(0) => poff_sw_sync_s,
      ref_clk_i => \^ref_clk_i\,
...
wb_nco_inst: entity work.double_dds_nco_counter_4_0_wb_nco_counter
     port map (
      D(1 downto 0) => readdata_s(1 downto 0),
      E(0) => max_accum_low_s,
      Q(39 downto 32) => data1(7 downto 0),
...
entity double_dds_nco_counter_4_0 is
  ...
  attribute NotValidForBitStream of double_dds_nco_counter_4_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of double_dds_nco_counter_4_0 : entity is "double_dds_nco_counter_3_0,nco_counter,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of double_dds_nco_counter_4_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of double_dds_nco_counter_4_0 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of double_dds_nco_counter_4_0 : entity is "nco_counter,Vivado 2019.2";
end double_dds_nco_counter_4_0;

architecture STRUCTURE of double_dds_nco_counter_4_0 is
  attribute COUNTER_SIZE : integer;
...
begin
U0: entity work.double_dds_nco_counter_4_0_nco_counter
     port map (
      cos_fake_o => cos_fake_o,
      dds_clk_o => dds_clk_o,
      dds_cos_o(15 downto 0) => dds_cos_o(15 downto 0),
