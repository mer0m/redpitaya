...
-- Date        : Wed May 10 18:17:49 2017
-- Host        : ux305 running 64-bit Debian GNU/Linux 9.0 (stretch)
-- Command     : write_vhdl -force -mode funcsim
--               /home/bma/git/fpga_design/redpitaya/double_dds/double_dds.srcs/sources_1/bd/double_dds_wrapper/ip/double_dds_wrapper_dds_ampl_1/double_dds_wrapper_dds_ampl_1_sim_netlist.vhdl
...
entity double_dds_wrapper_dds_ampl_1_add_const_handComm is
  port (
  ...
  attribute ORIG_REF_NAME of double_dds_wrapper_dds_ampl_1_add_const_handComm : entity is "add_const_handComm";
end double_dds_wrapper_dds_ampl_1_add_const_handComm;

architecture STRUCTURE of double_dds_wrapper_dds_ampl_1_add_const_handComm is
  ...
  signal \readdata_s[9]_i_3_n_0\ : STD_LOGIC;
  signal \readdata_s[9]_i_4_n_0\ : STD_LOGIC;
  signal \readdata_s[9]_i_5_n_0\ : STD_LOGIC;
  signal \readdata_s[9]_i_6_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \readdata_s[9]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \readdata_s[9]_i_3\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \readdata_s[9]_i_4\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \readdata_s[9]_i_5\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \readdata_s[9]_i_6\ : label is "soft_lutpair1";
begin
...
\offset_s[9]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
\readdata_s[9]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAA8A8AAAA08A80"
    )
        port map (
...
\readdata_s[9]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\readdata_s[9]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
\readdata_s[9]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFBF0080"
    )
        port map (
...
\readdata_s[9]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFBF0080"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity double_dds_wrapper_dds_ampl_1_add_const_logic is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of double_dds_wrapper_dds_ampl_1_add_const_logic : entity is "add_const_logic";
end double_dds_wrapper_dds_ampl_1_add_const_logic;

architecture STRUCTURE of double_dds_wrapper_dds_ampl_1_add_const_logic is
  signal add_val2_s : STD_LOGIC_VECTOR ( 9 downto 0 );
  signal add_val_s : STD_LOGIC_VECTOR ( 9 downto 0 );
  signal data_en_o_i_1_n_0 : STD_LOGIC;
  signal data_in_s : STD_LOGIC_VECTOR ( 9 downto 0 );
  ...
  signal \data_s_reg[9]_i_1_n_3\ : STD_LOGIC;
  signal \NLW_data_s_reg[9]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_data_s_reg[9]_i_1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
begin
...
\data_s[9]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\data_s[9]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\data_s_reg[9]_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => \data_s_reg[7]_i_1_n_0\,
      CO(3 downto 1) => \NLW_data_s_reg[9]_i_1_CO_UNCONNECTED\(3 downto 1),
      CO(0) => \data_s_reg[9]_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 1) => B"000",
      DI(0) => data_i(8),
      O(3 downto 2) => \NLW_data_s_reg[9]_i_1_O_UNCONNECTED\(3 downto 2),
      O(1 downto 0) => data_in_s(9 downto 8),
      S(3 downto 2) => B"00",
      S(1) => \data_s[9]_i_2_n_0\,
      S(0) => \data_s[9]_i_3_n_0\
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity double_dds_wrapper_dds_ampl_1_wb_add_const is
  port (
    Q : out STD_LOGIC_VECTOR ( 9 downto 0 );
    s00_axi_rdata : out STD_LOGIC_VECTOR ( 9 downto 0 );
    E : in STD_LOGIC_VECTOR ( 0 to 0 );
    s00_axi_wdata : in STD_LOGIC_VECTOR ( 9 downto 0 );
    s00_axi_aclk : in STD_LOGIC;
    s00_axi_reset : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of double_dds_wrapper_dds_ampl_1_wb_add_const : entity is "wb_add_const";
end double_dds_wrapper_dds_ampl_1_wb_add_const;

architecture STRUCTURE of double_dds_wrapper_dds_ampl_1_wb_add_const is
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity double_dds_wrapper_dds_ampl_1_add_const is
  port (
    s00_axi_aclk : in STD_LOGIC;
    s00_axi_reset : in STD_LOGIC;
  ...
  attribute C_S00_AXI_ADDR_WIDTH of double_dds_wrapper_dds_ampl_1_add_const : entity is 4;
  attribute C_S00_AXI_DATA_WIDTH : integer;
  attribute C_S00_AXI_DATA_WIDTH of double_dds_wrapper_dds_ampl_1_add_const : entity is 32;
  attribute DATA_IN_SIZE : integer;
  attribute DATA_IN_SIZE of double_dds_wrapper_dds_ampl_1_add_const : entity is 10;
  attribute DATA_OUT_SIZE : integer;
  attribute DATA_OUT_SIZE of double_dds_wrapper_dds_ampl_1_add_const : entity is 10;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of double_dds_wrapper_dds_ampl_1_add_const : entity is "add_const";
  attribute add_val : integer;
  attribute add_val of double_dds_wrapper_dds_ampl_1_add_const : entity is 0;
  attribute format : string;
  attribute format of double_dds_wrapper_dds_ampl_1_add_const : entity is "unsigned";
  attribute id : integer;
  attribute id of double_dds_wrapper_dds_ampl_1_add_const : entity is 1;
end double_dds_wrapper_dds_ampl_1_add_const;

architecture STRUCTURE of double_dds_wrapper_dds_ampl_1_add_const is
  signal \<const0>\ : STD_LOGIC;
  signal add_constHandComm_n_14 : STD_LOGIC;
  signal add_constHandComm_n_15 : STD_LOGIC;
  signal add_constHandComm_n_16 : STD_LOGIC;
...
add_constHandComm: entity work.double_dds_wrapper_dds_ampl_1_add_const_handComm
     port map (
      D(9 downto 1) => p_0_in(9 downto 1),
      D(0) => add_constHandComm_n_14,
      E(0) => add_constHandComm_n_15,
      Q(9 downto 0) => offset_s(9 downto 0),
      \readdata_s_reg[0]\(0) => add_constHandComm_n_16,
...
add_constLogic: entity work.double_dds_wrapper_dds_ampl_1_add_const_logic
     port map (
      Q(9 downto 0) => offset_s(9 downto 0),
      data_clk_i => \^data_clk_i\,
      data_en_i => data_en_i,
      ...
      data_o(9 downto 0) => data_o(9 downto 0),
      data_rst_i => \^data_rst_i\
    );
wb_add_const_inst: entity work.double_dds_wrapper_dds_ampl_1_wb_add_const
     port map (
      D(9 downto 1) => p_0_in(9 downto 1),
      D(0) => add_constHandComm_n_14,
      E(0) => add_constHandComm_n_15,
      Q(9 downto 0) => offset_s(9 downto 0),
      \axi_awaddr_reg[3]\(0) => add_constHandComm_n_16,
      s00_axi_aclk => s00_axi_aclk,
      s00_axi_rdata(9 downto 0) => \^s00_axi_rdata\(9 downto 0),
      s00_axi_reset => s00_axi_reset,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity double_dds_wrapper_dds_ampl_1 is
  port (
    s00_axi_aclk : in STD_LOGIC;
    s00_axi_reset : in STD_LOGIC;
    s00_axi_awaddr : in STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute NotValidForBitStream of double_dds_wrapper_dds_ampl_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of double_dds_wrapper_dds_ampl_1 : entity is "double_dds_wrapper_dds_ampl_1,add_const,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of double_dds_wrapper_dds_ampl_1 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of double_dds_wrapper_dds_ampl_1 : entity is "add_const,Vivado 2016.4";
end double_dds_wrapper_dds_ampl_1;

architecture STRUCTURE of double_dds_wrapper_dds_ampl_1 is
  attribute C_S00_AXI_ADDR_WIDTH : integer;
  attribute C_S00_AXI_ADDR_WIDTH of U0 : label is 4;
  attribute C_S00_AXI_DATA_WIDTH : integer;
  attribute C_S00_AXI_DATA_WIDTH of U0 : label is 32;
  attribute DATA_IN_SIZE : integer;
  attribute DATA_IN_SIZE of U0 : label is 10;
  attribute DATA_OUT_SIZE : integer;
  attribute DATA_OUT_SIZE of U0 : label is 10;
  attribute add_val : integer;
...
begin
U0: entity work.double_dds_wrapper_dds_ampl_1_add_const
     port map (
      data_clk_i => data_clk_i,
