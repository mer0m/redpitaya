...
class MyApp(App):
	...
	def main(self):
		...
		self.sd_adc2_offset = gui.SpinBox(0, -8192, 8191, 1, width="60%", margin="10px")
		...
		self.sd_dds1_f0 = gui.SpinBox(0, 0, 62500000, 1, width="60%", margin="10px")
		...
		self.sd_dds1_range = gui.SpinBox(0, -8192, 8191, 1, width="60%", margin="10px")
		...
		self.sd_dds2_f0 = gui.Slider(0, 0, 62500000, 1, width="60%", margin="10px")
		self.sd_dds2_f0.set_oninput_listener(self.sd_dds2_f0_changed)
		self.sd_dds2_f0 = gui.SpinBox(0, 0, 62500000, 1, width="60%", margin="10px")
		...
		self.hbox_dds2_range = gui.HBox(margin="10px")
		self.lb_dds2_range = gui.Label("/dev/dds2_range", width="20%", margin="10px")
		self.sd_dds2_range = gui.Slider(0, -8192, 8191, 1, width="60%", margin="10px")
		self.sd_dds2_range.set_oninput_listener(self.sd_dds2_range_changed)
		self.sd_dds2_range = gui.SpinBox(0, -8192, 8191, 1, width="60%", margin="10px")
		self.sb_dds2_range.set_on_change_listener(self.sb_dds2_range_changed)
		self.sd_dds2_range_changed(self.sd_dds2_range, self.sd_dds2_range.get_value())
		self.hbox_dds2_range.append(self.lb_dds2_range)
		self.hbox_dds2_range.append(self.sd_dds2_range)
		self.hbox_dds2_range.append(self.sb_dds2_range)
		self.w.append(self.hbox_dds2_range)
		...
		self.sd_pid1_kp = gui.SpinBox(0, -8192, 8191, 1, width="60%", margin="10px")
		...
		self.sd_pid1_ki = gui.SpinBox(0, -8192, 8191, 1, width="60%", margin="10px")
		...
		self.sd_pid1_kd = gui.SpinBox(0, -8192, 8191, 1, width="60%", margin="10px")
		...
		self.sd_pid1_rst_int = gui.SpinBox(0, -8192, 8191, 1, width="60%", margin="10px")
		...
		self.sd_pid1_sign = gui.SpinBox(0, -8192, 8191, 1, width="60%", margin="10px")
		...
		self.sd_pid1_setpoint = gui.SpinBox(0, -8192, 8191, 1, width="60%", margin="10px")
		...
		self.sd_pid2_kp = gui.SpinBox(0, -8192, 8191, 1, width="60%", margin="10px")
		...
		self.sd_pid2_ki = gui.SpinBox(0, -8192, 8191, 1, width="60%", margin="10px")
		...
		self.sd_pid2_kd = gui.SpinBox(0, -8192, 8191, 1, width="60%", margin="10px")
		...
		self.sd_pid2_rst_int = gui.SpinBox(0, -8192, 8191, 1, width="60%", margin="10px")
		...
		self.sd_pid2_sign = gui.SpinBox(0, -8192, 8191, 1, width="60%", margin="10px")
		...
		self.sd_pid2_setpoint = gui.SpinBox(0, -8192, 8191, 1, width="60%", margin="10px")
	...
	def sd_dds2_f0_changed(self, widget, value):
		...
		liboscimp_fpga.add_const_set_offset("/dev/dds2_f0", int(int(value)/(125e6/2**32)))
		self.sb_dds2_f0.set_value(value)

	def sb_dds2_f0_changed(self, widget, value):
		print("/dev/dds2_f0", int(value))
		liboscimp_fpga.add_const_set_offset("/dev/dds2_f0", int(int(value)/(125e6/2**32)))
		self.sd_dds2_f0.set_value(value)
	...
	def sd_dds2_range_changed(self, widget, value):
		print("/dev/dds2_range", int(value))
		liboscimp_fpga.add_const_set_offset("/dev/dds2_range", int(value))
		self.sb_dds2_range.set_value(value)

	def sb_dds2_range_changed(self, widget, value):
		print("/dev/dds2_range", int(value))
		liboscimp_fpga.add_const_set_offset("/dev/dds2_range", int(value))
		self.sd_dds2_range.set_value(value)
