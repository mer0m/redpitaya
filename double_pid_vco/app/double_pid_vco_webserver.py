...
class MyApp(App):
	...
	def main(self):
		...
		self.sb_dds2_ampl = gui.SpinBox(0, -8192, 8191, 1, width="20%", margin="10px")
		...
		self.sb_dds2_f0 = gui.SpinBox(0, 0, 62500000, 1, width="20%", margin="10px")
		...
		self.sb_dds2_offset = gui.SpinBox(0, -8192, 8191, 1, width="20%", margin="10px")
		...
		self.sb_dds2_range = gui.SpinBox(0, -8192, 8191, 1, width="20%", margin="10px")
...
start(MyApp, address="0.0.0.0", port=80, title="double_pid_vco_webserver")
