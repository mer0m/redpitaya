...
class MyApp(App):
	...
	def main(self):
		...
		self.sd_dds2_f0 = gui.Slider(0, -8192, 8191, 1, width="60%", margin="10px")
		self.sd_dds2_f0.set_oninput_listener(self.sd_dds2_f0_changed)
		self.sb_dds2_f0 = gui.SpinBox(0, -8192, 8191, 1, width="20%", margin="10px")
	...
	def sd_dds2_f0_changed(self, widget, value):
		...
		liboscimp_fpga.add_const_set_offset("/dev/dds2_f0", int(value))
