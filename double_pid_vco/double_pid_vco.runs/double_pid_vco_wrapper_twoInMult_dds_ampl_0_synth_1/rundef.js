...
ISEStep( "vivado",
         "-log double_pid_vco_wrapper_twoInMult_dds_ampl_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source double_pid_vco_wrapper_twoInMult_dds_ampl_0.tcl" );
