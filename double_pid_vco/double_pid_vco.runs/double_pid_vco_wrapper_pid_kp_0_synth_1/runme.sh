...
HD_PWD='/home/bma/git/fpga_design/redpitaya/double_pid_vco/double_pid_vco.runs/double_pid_vco_wrapper_pid_kp_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log double_pid_vco_wrapper_pid_kp_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source double_pid_vco_wrapper_pid_kp_0.tcl
