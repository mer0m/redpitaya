...
HD_PWD='/home/bma/git/fpga_design/redpitaya/pid_vco_bypass_pid_only/pid_vco_bypass_pid_only.runs/pid_vco_bypass_pid_only_wrapper_pid2_rst_int_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pid_vco_bypass_pid_only_wrapper_pid2_rst_int_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pid_vco_bypass_pid_only_wrapper_pid2_rst_int_0.tcl
