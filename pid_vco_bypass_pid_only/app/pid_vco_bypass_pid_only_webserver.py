...
class MyApp(App):
	...
	def main(self):
		...
		self.hbox_switchComplex_pid2_input = gui.HBox(margin="10px")
		self.cb_switchComplex_pid2_input = gui.CheckBoxLabel("switchComplex_pid2_input", True, width="5%", margin="10px")
		self.cb_switchComplex_pid2_input.set_on_change_listener(self.cb_switchComplex_pid2_input_changed)
		self.hbox_switchComplex_pid2_input.append(self.cb_switchComplex_pid2_input)
		self.w.append(self.hbox_switchComplex_pid2_input)

		self.hbox_switchComplex_vco = gui.HBox(margin="10px")
		self.cb_switchComplex_vco = gui.CheckBoxLabel("switchComplex_vco", True, width="5%", margin="10px")
		self.cb_switchComplex_vco.set_on_change_listener(self.cb_switchComplex_vco_changed)
		self.hbox_switchComplex_vco.append(self.cb_switchComplex_vco)
		self.w.append(self.hbox_switchComplex_vco)
	...
	def cb_switchComplex_pid2_input_changed(self, widget, value):
		print("/dev/switchComplex_pid2_input", int(self.cb_switchComplex_pid2_input.get_value()))
		liboscimp_fpga.swC_send_conf("/dev/switchComplex_pid2_input", int(self.cb_switchComplex_pid2_input.get_value()))

	def cb_switchComplex_vco_changed(self, widget, value):
		print("/dev/switchComplex_vco", int(self.cb_switchComplex_vco.get_value()))
		liboscimp_fpga.swC_send_conf("/dev/switchComplex_vco", int(self.cb_switchComplex_vco.get_value()))

start(MyApp, address="0.0.0.0", port=80, title="pid_vco_bypass_pid_only_webserver")
