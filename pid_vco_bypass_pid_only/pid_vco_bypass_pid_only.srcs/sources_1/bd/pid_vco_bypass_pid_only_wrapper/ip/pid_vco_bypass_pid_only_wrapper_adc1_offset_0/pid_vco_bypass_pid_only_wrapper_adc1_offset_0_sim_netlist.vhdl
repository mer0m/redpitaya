...
-- Date        : Mon Nov 27 12:23:11 2017
-- Host        : ux305 running 64-bit Debian GNU/Linux 9.1 (stretch)
-- Command     : write_vhdl -force -mode funcsim
--               /home/bma/git/fpga_design/redpitaya/pid_vco_bypass_pid_only/pid_vco_bypass_pid_only.srcs/sources_1/bd/pid_vco_bypass_pid_only_wrapper/ip/pid_vco_bypass_pid_only_wrapper_adc1_offset_0/pid_vco_bypass_pid_only_wrapper_adc1_offset_0_sim_netlist.vhdl
...
entity pid_vco_bypass_pid_only_wrapper_adc1_offset_0_add_const_handComm is
  port (
  ...
  attribute ORIG_REF_NAME of pid_vco_bypass_pid_only_wrapper_adc1_offset_0_add_const_handComm : entity is "add_const_handComm";
end pid_vco_bypass_pid_only_wrapper_adc1_offset_0_add_const_handComm;

architecture STRUCTURE of pid_vco_bypass_pid_only_wrapper_adc1_offset_0_add_const_handComm is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity pid_vco_bypass_pid_only_wrapper_adc1_offset_0_add_const_logic is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of pid_vco_bypass_pid_only_wrapper_adc1_offset_0_add_const_logic : entity is "add_const_logic";
end pid_vco_bypass_pid_only_wrapper_adc1_offset_0_add_const_logic;

architecture STRUCTURE of pid_vco_bypass_pid_only_wrapper_adc1_offset_0_add_const_logic is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity pid_vco_bypass_pid_only_wrapper_adc1_offset_0_wb_add_const is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of pid_vco_bypass_pid_only_wrapper_adc1_offset_0_wb_add_const : entity is "wb_add_const";
end pid_vco_bypass_pid_only_wrapper_adc1_offset_0_wb_add_const;

architecture STRUCTURE of pid_vco_bypass_pid_only_wrapper_adc1_offset_0_wb_add_const is
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity pid_vco_bypass_pid_only_wrapper_adc1_offset_0_add_const is
  port (
    s00_axi_aclk : in STD_LOGIC;
    s00_axi_reset : in STD_LOGIC;
  ...
  attribute C_S00_AXI_ADDR_WIDTH of pid_vco_bypass_pid_only_wrapper_adc1_offset_0_add_const : entity is 4;
  attribute C_S00_AXI_DATA_WIDTH : integer;
  attribute C_S00_AXI_DATA_WIDTH of pid_vco_bypass_pid_only_wrapper_adc1_offset_0_add_const : entity is 32;
  attribute DATA_IN_SIZE : integer;
  attribute DATA_IN_SIZE of pid_vco_bypass_pid_only_wrapper_adc1_offset_0_add_const : entity is 14;
  attribute DATA_OUT_SIZE : integer;
  attribute DATA_OUT_SIZE of pid_vco_bypass_pid_only_wrapper_adc1_offset_0_add_const : entity is 14;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of pid_vco_bypass_pid_only_wrapper_adc1_offset_0_add_const : entity is "add_const";
  attribute add_val : integer;
  attribute add_val of pid_vco_bypass_pid_only_wrapper_adc1_offset_0_add_const : entity is 0;
  attribute format : string;
  attribute format of pid_vco_bypass_pid_only_wrapper_adc1_offset_0_add_const : entity is "signed";
  attribute id : integer;
  attribute id of pid_vco_bypass_pid_only_wrapper_adc1_offset_0_add_const : entity is 1;
end pid_vco_bypass_pid_only_wrapper_adc1_offset_0_add_const;

architecture STRUCTURE of pid_vco_bypass_pid_only_wrapper_adc1_offset_0_add_const is
...
add_constHandComm: entity work.pid_vco_bypass_pid_only_wrapper_adc1_offset_0_add_const_handComm
     port map (
      D(13) => p_0_in(31),
...
add_constLogic: entity work.pid_vco_bypass_pid_only_wrapper_adc1_offset_0_add_const_logic
     port map (
      Q(13 downto 0) => offset_s(13 downto 0),
      data_clk_i => \^data_clk_i\,
      data_en_i => data_en_i,
...
wb_add_const_inst: entity work.pid_vco_bypass_pid_only_wrapper_adc1_offset_0_wb_add_const
     port map (
      D(13) => p_0_in(31),
      D(12 downto 1) => p_0_in(12 downto 1),
      D(0) => add_constHandComm_n_18,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity pid_vco_bypass_pid_only_wrapper_adc1_offset_0 is
  port (
    s00_axi_aclk : in STD_LOGIC;
    s00_axi_reset : in STD_LOGIC;
    s00_axi_awaddr : in STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute NotValidForBitStream of pid_vco_bypass_pid_only_wrapper_adc1_offset_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of pid_vco_bypass_pid_only_wrapper_adc1_offset_0 : entity is "pid_vco_bypass_pid_only_wrapper_adc1_offset_0,add_const,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of pid_vco_bypass_pid_only_wrapper_adc1_offset_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of pid_vco_bypass_pid_only_wrapper_adc1_offset_0 : entity is "add_const,Vivado 2016.4";
end pid_vco_bypass_pid_only_wrapper_adc1_offset_0;

architecture STRUCTURE of pid_vco_bypass_pid_only_wrapper_adc1_offset_0 is
  attribute C_S00_AXI_ADDR_WIDTH : integer;
...
begin
U0: entity work.pid_vco_bypass_pid_only_wrapper_adc1_offset_0_add_const
     port map (
      data_clk_i => data_clk_i,
