...
-- Date        : Mon Nov 27 12:01:08 2017
-- Host        : ux305 running 64-bit Debian GNU/Linux 9.1 (stretch)
-- Command     : write_vhdl -force -mode funcsim
--               /home/bma/git/fpga_design/redpitaya/pid_vco_bypass_pid_only/pid_vco_bypass_pid_only.srcs/sources_1/bd/pid_vco_bypass_pid_only_wrapper/ip/pid_vco_bypass_pid_only_wrapper_pid2_0/pid_vco_bypass_pid_only_wrapper_pid2_0_sim_netlist.vhdl
-- Design      : pid_vco_bypass_pid_only_wrapper_pid2_0
...
entity pid_vco_bypass_pid_only_wrapper_pid2_0_red_pitaya_pidv3_logic is
  port (
  ...
  attribute ORIG_REF_NAME of pid_vco_bypass_pid_only_wrapper_pid2_0_red_pitaya_pidv3_logic : entity is "red_pitaya_pidv3_logic";
end pid_vco_bypass_pid_only_wrapper_pid2_0_red_pitaya_pidv3_logic;

architecture STRUCTURE of pid_vco_bypass_pid_only_wrapper_pid2_0_red_pitaya_pidv3_logic is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity pid_vco_bypass_pid_only_wrapper_pid2_0_red_pitaya_pidv3 is
  port (
    data_o : out STD_LOGIC_VECTOR ( 13 downto 0 );
    data_en_o : out STD_LOGIC;
    data_i : in STD_LOGIC_VECTOR ( 13 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of pid_vco_bypass_pid_only_wrapper_pid2_0_red_pitaya_pidv3 : entity is "red_pitaya_pidv3";
end pid_vco_bypass_pid_only_wrapper_pid2_0_red_pitaya_pidv3;

architecture STRUCTURE of pid_vco_bypass_pid_only_wrapper_pid2_0_red_pitaya_pidv3 is
begin
red_pitaya_pidv3Logic: entity work.pid_vco_bypass_pid_only_wrapper_pid2_0_red_pitaya_pidv3_logic
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity pid_vco_bypass_pid_only_wrapper_pid2_0 is
  port (
    data_i : in STD_LOGIC_VECTOR ( 13 downto 0 );
    data_en_i : in STD_LOGIC;
    data_clk_i : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of pid_vco_bypass_pid_only_wrapper_pid2_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of pid_vco_bypass_pid_only_wrapper_pid2_0 : entity is "pid_vco_bypass_pid_only_wrapper_pid2_0,red_pitaya_pidv3,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of pid_vco_bypass_pid_only_wrapper_pid2_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of pid_vco_bypass_pid_only_wrapper_pid2_0 : entity is "red_pitaya_pidv3,Vivado 2016.4";
end pid_vco_bypass_pid_only_wrapper_pid2_0;

architecture STRUCTURE of pid_vco_bypass_pid_only_wrapper_pid2_0 is
...
U0: entity work.pid_vco_bypass_pid_only_wrapper_pid2_0_red_pitaya_pidv3
     port map (
      data_clk_i => \^data_clk_i\,
      data_en_i => data_en_i,
      data_en_o => data_en_o,
