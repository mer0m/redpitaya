...
HD_PWD='/home/bma/git/fpga_design/redpitaya/iq_pid_vco/iq_pid_vco.runs/iq_pid_vco_wrapper_pid_setpoint_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iq_pid_vco_wrapper_pid_setpoint_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iq_pid_vco_wrapper_pid_setpoint_0.tcl
