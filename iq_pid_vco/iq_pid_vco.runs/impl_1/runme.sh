...
HD_PWD='/home/bma/git/fpga_design/redpitaya/iq_pid_vco/iq_pid_vco.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log iq_pid_vco_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source iq_pid_vco_wrapper.tcl -notrace
