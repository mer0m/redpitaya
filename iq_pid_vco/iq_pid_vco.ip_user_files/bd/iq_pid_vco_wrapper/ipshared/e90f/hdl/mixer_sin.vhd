...
architecture Behavioral of mixer_sin is
	...
	--signal nco_rst_sync_m1_s, nco_rst_sync_s, nco_rst_s : std_logic;
begin
	...
	--	if rising_edge(data_clk_i) then
	--		rst_sync_m1_s <= processing_rst_i;
	...
	--process(nco_clk_i) begin
	--	if rising_edge(nco_clk_i) then
	--		nco_rst_sync_m1_s <= processing_rst_i;
	--		nco_rst_sync_s <= nco_rst_sync_m1_s;
	--		nco_rst_s <= nco_rst_sync_s;
	--	end if;
	--end process;
