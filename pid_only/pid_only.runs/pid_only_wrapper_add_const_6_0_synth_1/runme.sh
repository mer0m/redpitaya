...
HD_PWD='/home/bma/git/fpga_design/redpitaya/pid_only/pid_only.runs/pid_only_wrapper_add_const_6_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pid_only_wrapper_add_const_6_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pid_only_wrapper_add_const_6_0.tcl
