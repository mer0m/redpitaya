...
HD_PWD='/home/bma/git/fpga_design/redpitaya/pid_only/pid_only.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pid_only_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pid_only_wrapper.tcl
