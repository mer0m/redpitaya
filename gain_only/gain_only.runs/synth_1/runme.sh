...
HD_PWD='/home/bma/git/fpga_design/redpitaya/gain_only/gain_only.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gain_only_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gain_only_wrapper.tcl
