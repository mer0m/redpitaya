...
HD_PWD='/home/bma/git/fpga_design/redpitaya/gain_only/gain_only.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gain_only_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gain_only_wrapper.tcl -notrace
