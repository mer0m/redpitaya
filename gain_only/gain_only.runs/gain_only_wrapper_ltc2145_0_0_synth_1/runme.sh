...
HD_PWD='/home/bma/git/fpga_design/redpitaya/gain_only/gain_only.runs/gain_only_wrapper_ltc2145_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gain_only_wrapper_ltc2145_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gain_only_wrapper_ltc2145_0_0.tcl
