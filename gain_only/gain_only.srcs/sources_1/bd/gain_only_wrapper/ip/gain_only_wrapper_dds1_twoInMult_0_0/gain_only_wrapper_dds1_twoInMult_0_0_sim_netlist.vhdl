...
--               /home/bma/git/fpga_design/redpitaya/gain_only/gain_only.srcs/sources_1/bd/gain_only_wrapper/ip/gain_only_wrapper_dds1_twoInMult_0_0/gain_only_wrapper_dds1_twoInMult_0_0_sim_netlist.vhdl
...
entity gain_only_wrapper_dds1_twoInMult_0_0_twoInMult is
  port (
  ...
  attribute ORIG_REF_NAME of gain_only_wrapper_dds1_twoInMult_0_0_twoInMult : entity is "twoInMult";
end gain_only_wrapper_dds1_twoInMult_0_0_twoInMult;

architecture STRUCTURE of gain_only_wrapper_dds1_twoInMult_0_0_twoInMult is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity gain_only_wrapper_dds1_twoInMult_0_0 is
  port (
    data1_i : in STD_LOGIC_VECTOR ( 13 downto 0 );
    data1_en_i : in STD_LOGIC;
    data1_clk_i : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of gain_only_wrapper_dds1_twoInMult_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of gain_only_wrapper_dds1_twoInMult_0_0 : entity is "gain_only_wrapper_dds1_twoInMult_0_0,twoInMult,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of gain_only_wrapper_dds1_twoInMult_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of gain_only_wrapper_dds1_twoInMult_0_0 : entity is "twoInMult,Vivado 2016.4";
end gain_only_wrapper_dds1_twoInMult_0_0;

architecture STRUCTURE of gain_only_wrapper_dds1_twoInMult_0_0 is
  signal \^data1_clk_i\ : STD_LOGIC;
begin
  \^data1_clk_i\ <= data1_clk_i;
  data_clk_o <= \^data1_clk_i\;
U0: entity work.gain_only_wrapper_dds1_twoInMult_0_0_twoInMult
     port map (
      data1_clk_i => \^data1_clk_i\,
