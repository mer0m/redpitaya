...
-- Date        : Thu Dec  7 10:22:39 2017
-- Host        : ux305 running 64-bit Debian GNU/Linux 9.1 (stretch)
-- Command     : write_vhdl -force -mode funcsim
--               /home/bma/git/fpga_design/redpitaya/gain_only/gain_only.srcs/sources_1/bd/gain_only_wrapper/ip/gain_only_wrapper_dds2_phase_0/gain_only_wrapper_dds2_phase_0_sim_netlist.vhdl
-- Design      : gain_only_wrapper_dds2_phase_0
...
entity gain_only_wrapper_dds2_phase_0_add_const_handComm is
  port (
  ...
  attribute ORIG_REF_NAME of gain_only_wrapper_dds2_phase_0_add_const_handComm : entity is "add_const_handComm";
end gain_only_wrapper_dds2_phase_0_add_const_handComm;

architecture STRUCTURE of gain_only_wrapper_dds2_phase_0_add_const_handComm is
  ...
  signal \readdata_s[15]_i_3_n_0\ : STD_LOGIC;
  signal \readdata_s[15]_i_4_n_0\ : STD_LOGIC;
  signal \readdata_s[15]_i_5_n_0\ : STD_LOGIC;
  signal \readdata_s[15]_i_6_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \readdata_s[15]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \readdata_s[15]_i_3\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \readdata_s[15]_i_4\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \readdata_s[15]_i_5\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \readdata_s[15]_i_6\ : label is "soft_lutpair1";
begin
...
\offset_s[15]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
\readdata_s[15]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAA8A8AAAA08A80"
    )
        port map (
...
\readdata_s[15]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\readdata_s[15]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
\readdata_s[15]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFBF0080"
    )
        port map (
...
\readdata_s[15]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFBF0080"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity gain_only_wrapper_dds2_phase_0_add_const_logic is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of gain_only_wrapper_dds2_phase_0_add_const_logic : entity is "add_const_logic";
end gain_only_wrapper_dds2_phase_0_add_const_logic;

architecture STRUCTURE of gain_only_wrapper_dds2_phase_0_add_const_logic is
  signal add_val2_s : STD_LOGIC_VECTOR ( 15 downto 0 );
  signal add_val_s : STD_LOGIC_VECTOR ( 15 downto 0 );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity gain_only_wrapper_dds2_phase_0_wb_add_const is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of gain_only_wrapper_dds2_phase_0_wb_add_const : entity is "wb_add_const";
end gain_only_wrapper_dds2_phase_0_wb_add_const;

architecture STRUCTURE of gain_only_wrapper_dds2_phase_0_wb_add_const is
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity gain_only_wrapper_dds2_phase_0_add_const is
  port (
    s00_axi_aclk : in STD_LOGIC;
    s00_axi_reset : in STD_LOGIC;
  ...
  attribute C_S00_AXI_ADDR_WIDTH of gain_only_wrapper_dds2_phase_0_add_const : entity is 4;
  attribute C_S00_AXI_DATA_WIDTH : integer;
  attribute C_S00_AXI_DATA_WIDTH of gain_only_wrapper_dds2_phase_0_add_const : entity is 32;
  attribute DATA_IN_SIZE : integer;
  attribute DATA_IN_SIZE of gain_only_wrapper_dds2_phase_0_add_const : entity is 16;
  attribute DATA_OUT_SIZE : integer;
  attribute DATA_OUT_SIZE of gain_only_wrapper_dds2_phase_0_add_const : entity is 16;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of gain_only_wrapper_dds2_phase_0_add_const : entity is "add_const";
  attribute add_val : integer;
  attribute add_val of gain_only_wrapper_dds2_phase_0_add_const : entity is 0;
  attribute format : string;
  attribute format of gain_only_wrapper_dds2_phase_0_add_const : entity is "unsigned";
  attribute id : integer;
  attribute id of gain_only_wrapper_dds2_phase_0_add_const : entity is 1;
end gain_only_wrapper_dds2_phase_0_add_const;

architecture STRUCTURE of gain_only_wrapper_dds2_phase_0_add_const is
  signal \<const0>\ : STD_LOGIC;
  signal add_constHandComm_n_20 : STD_LOGIC;
  signal add_constHandComm_n_21 : STD_LOGIC;
  signal add_constHandComm_n_22 : STD_LOGIC;
...
add_constHandComm: entity work.gain_only_wrapper_dds2_phase_0_add_const_handComm
     port map (
      D(15 downto 1) => p_0_in(15 downto 1),
      D(0) => add_constHandComm_n_20,
      E(0) => add_constHandComm_n_21,
      Q(15 downto 0) => offset_s(15 downto 0),
      \readdata_s_reg[0]\(0) => add_constHandComm_n_22,
...
add_constLogic: entity work.gain_only_wrapper_dds2_phase_0_add_const_logic
     port map (
      Q(15 downto 0) => offset_s(15 downto 0),
      data_clk_i => \^data_clk_i\,
      data_en_i => data_en_i,
...
wb_add_const_inst: entity work.gain_only_wrapper_dds2_phase_0_wb_add_const
     port map (
      D(15 downto 1) => p_0_in(15 downto 1),
      D(0) => add_constHandComm_n_20,
      E(0) => add_constHandComm_n_21,
      Q(15 downto 0) => offset_s(15 downto 0),
      \axi_awaddr_reg[3]\(0) => add_constHandComm_n_22,
      s00_axi_aclk => s00_axi_aclk,
      s00_axi_rdata(15 downto 0) => \^s00_axi_rdata\(15 downto 0),
      s00_axi_reset => s00_axi_reset,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity gain_only_wrapper_dds2_phase_0 is
  port (
    s00_axi_aclk : in STD_LOGIC;
    s00_axi_reset : in STD_LOGIC;
    s00_axi_awaddr : in STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute NotValidForBitStream of gain_only_wrapper_dds2_phase_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of gain_only_wrapper_dds2_phase_0 : entity is "gain_only_wrapper_dds2_phase_0,add_const,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of gain_only_wrapper_dds2_phase_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of gain_only_wrapper_dds2_phase_0 : entity is "add_const,Vivado 2016.4";
end gain_only_wrapper_dds2_phase_0;

architecture STRUCTURE of gain_only_wrapper_dds2_phase_0 is
  attribute C_S00_AXI_ADDR_WIDTH : integer;
...
begin
U0: entity work.gain_only_wrapper_dds2_phase_0_add_const
     port map (
      data_clk_i => data_clk_i,
