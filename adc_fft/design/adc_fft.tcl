...
add_ip_and_conf dupplReal adc1_dupl {
    DATA_SIZE 14 \
    NB_OUTPUT 2 }
connect_intf redpitaya_converters_0 dataA_out adc1_dupl data_in
...
add_ip_and_conf windowReal win1 {
	...
	COEFF_ADDR_SIZE 11 \
	COEFF_SIZE 16 }
connect_proc win1 s00_axi 0x00000
...
add_ip_and_conf fft fft1 {
    ...
    DATA_SIZE 32 \
	USE_EOF true }
connect_proc fft1 s00_axi 0x10000
...
add_ip_and_conf dupplReal adc2_dupl {
    DATA_SIZE 14 \
    NB_OUTPUT 2 }
connect_intf redpitaya_converters_0 dataB_out adc2_dupl data_in
...
add_ip_and_conf windowReal win2 {
	...
	COEFF_ADDR_SIZE 11 \
	COEFF_SIZE 16 }
connect_proc win2 s00_axi 0x20000
...
add_ip_and_conf fft fft2 {
    ...
    DATA_SIZE 32 \
	USE_EOF true }
connect_proc fft2 s00_axi 0x30000
...
add_ip_and_conf dataReal_to_ram data_adc12 {
	...
	NB_INPUT 2 \
	NB_SAMPLE 2048 }
connect_proc data_adc12 s00_axi 0x40000
...
add_ip_and_conf dataComplex_to_ram data_fft12 {
	...
	NB_INPUT 2 \
	NB_SAMPLE 2048 }
connect_proc data_fft12 s00_axi 0x60000
